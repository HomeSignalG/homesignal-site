...
// 9c: the banner no longer points at EPA records "below" — they stopped rendering in the What's
// changing feed (founder decision, 2026-09-25). The composition it is gated on (9, 9b) is unchanged.
