...
## Run 2026-07-17T09:08:45.880Z

- Sources re-probed: **18** · discovery targets walked: **44** · candidates evaluated: **197**
- Auto-wired: **none**
- Flagged new shapes (connector work needed — never guessed): **146**
- Dev-backed ZIPs snapshot: **1081** (Δ +836 vs last run)
...
| sandiego-county-arcgis | no-candidates | 61 services listed; none match the permit/land-use pattern |
| sanjose-ckan | flag | CKAN catalog with 7 permit-pattern dataset(s): Active Building Permits; Expired Building Permits; Last 30 days Planning Permits; Last 30 days building permits; Residential Parking Permit (RPP) Zones |
| santaclara-county-socrata → County of Santa Clara Permitted Body Art Facilities and Permitted Body Art Practitioners (mqx2-w62f) | flag | updated 2026-07-17; columns: facility_name, permit_type, site_address, city, zip, permitexpdate, facility_id, geo_address… |
| santaclara-county-socrata → County of Santa Clara Active Body Art Facilities and Permitted Body Art Practitioners (jwgu-xsep) | still-stale | rowsUpdatedAt = 2018-11-27 (> 400d old) |
| sunnyvale-arcgis-hub | unreachable | DCAT HTTP 0 UND_ERR_CONNECT_TIMEOUT |
| oakland-socrata → Residential Parking Permit Zones (su5x-2u99) | still-stale | rowsUpdatedAt = 2019-09-03 (> 400d old) |
| alameda-county-socrata | still-dead | catalog HTTP 404 <!DOCTYPE html>
...
| contracosta-county-arcgis → _Authoritative/Zoning/PLA_DCD_Zoning | flag | layer "PLA_DCD_Zoning" is esriGeometryPolygon |
| contracosta-county-arcgis → _Authoritative/Zoning/PLA_DCD_Zoning | flag | layer "PLA_DCD_Zoning" is esriGeometryPolygon |
| sonoma-county-socrata → Sonoma County Planning Permits (m689-iiuu) | flag | updated 2026-07-16; columns: file, status, application_type, started, address, description, parcel, sub_type… |
| sonoma-county-socrata → Sonoma County Rebuilding Permits (652y-5ihx) | flag | updated 2026-06-15; columns: record_id, date_opened, record_type, permit_status, category, permit_description, units, buildings, total_square_feet, situs_address, area_id, supervisors_district, event_title, first_inspection_date, parcel_number… |
| sonoma-county-socrata → Sonoma County Construction Permits (88ms-k5e7) | flag | updated 2026-07-16; columns: file_number, status, application_type, started, issued, address, description, assessors_parcel_number, totfee, value… |
| ventura-county-arcgis → DataDownloads/LandUse/Area plans | flag | layer "Area plans" is esriGeometryPolygon |
| ventura-county-arcgis → DataDownloads/LandUse/General Plan | flag | layer "General Plan" is esriGeometryPolygon |
| ventura-county-arcgis → DataDownloads/LandUse/Zone Designation | flag | layer "Zone Designation" is esriGeometryPolygon |
| ventura-county-arcgis → DataDownloads/LandUse/Area plans | flag | layer "Area plans" is esriGeometryPolygon |
...
| maricopa-county-arcgis → GIO/PermitHistory/Permit (Line) | flag | layer "Permit (Line)" is esriGeometryPolyline |
| maricopa-county-arcgis → GIO/PermitHistory/Permit (Polygon) | flag | layer "Permit (Polygon)" is esriGeometryPolygon |
| maricopa-county-arcgis → GIO/PermitHistory/Permit History (Point) | flag | fresh (newest 2026-07-16) but no lexicon status column among: OBJECTID, ModuleName, CaseID, CaseNumber, CaseType, WorkClass, ApplicationDate, ProjectID, ProjectName, GISHistoryQueueID, SpatialType, SpatialID |
| maricopa-county-arcgis → GIO/PermitHistory/Permit History (Line) | flag | layer "Permit History (Line)" is esriGeometryPolyline |
| maricopa-county-arcgis → GIO/PermitHistory/Permit History (Polygon) | flag | layer "Permit History (Polygon)" is esriGeometryPolygon |
| maricopa-county-arcgis → GIO/PermitHistory/Permit (Point) | flag | fresh (newest 2026-01-23) but no lexicon status column among: OBJECTID, Name, Description, CreatedDate, SHAPE |
| maricopa-county-arcgis → GIO/PermitHistory/Permit (Line) | flag | layer "Permit (Line)" is esriGeometryPolyline |
| maricopa-county-arcgis → GIO/PermitHistory/Permit (Polygon) | flag | layer "Permit (Polygon)" is esriGeometryPolygon |
| maricopa-county-arcgis → GIO/PermitHistory/Permit History (Point) | flag | fresh (newest 2026-07-16) but no lexicon status column among: OBJECTID, ModuleName, CaseID, CaseNumber, CaseType, WorkClass, ApplicationDate, ProjectID, ProjectName, GISHistoryQueueID, SpatialType, SpatialID, SHAPE |
| tucson-dcat → Zoning - Tucson - Open Data | flag | layer "ZONE_COT" is esriGeometryPolygon |
| tucson-dcat → Redevelopment Plans - Open Data | flag | layer "ZZ_PLAN_REDEV" is esriGeometryPolygon |
| tucson-dcat → Original City Zoning - Open Data | flag | layer "ZONE_OCZ" is esriGeometryPolygon |
| tucson-dcat → Subdivisions - Open Data | flag | layer "SUBDIV" is esriGeometryPolygon |
...
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http |
| montgomery-county-socrata → Mechanical Permits (ih88-a6aa) | flag | updated 2026-07-17; columns: permitno, status, stno, pre_direction, stname, suffix, postdir, city, state, zip, worktype, usecode, addeddate, issueddate, finaleddate… |
| montgomery-county-socrata → Electrical Building Permits (qxie-8qnp) | flag | updated 2026-07-17; columns: permitno, status, stno, predir, stname, suffix, postdir, city, state, zip, worktype, usecode, addeddate, issueddate, finaleddate… |
| montgomery-county-socrata → DPS - Antenna/Wireless Permits (djk9-h36c) | flag | updated 2026-07-16; columns: permit_number, permit_status, added_date, issue_date, final_date, tfcg_number, attachment_type, ozah, street_number, pre_direction, street_name, street_suffix, post_direction, city, state… |
| montgomery-county-socrata → Fence Permits (9quz-avmj) | flag | updated 2026-07-17; columns: application_type, permit_number, work_type, user_code, added_date, issue_date, final_date, expired_date, status, building_area, description_of_work, street_number, pre_direction, street_name, street_suffix… |
| montgomery-county-socrata → Sign Permits (piic-h4rw) | flag | updated 2026-07-17; columns: application_type, permit_no, work_type, use_code, added_date, issued_date, final_date, expired_date, status, building_area, description, st_no, pre_dir, st_name, suffix… |
| howard-county-socrata → Office of Consumer Protection Permits And Licenses (9rfk-bak7) | still-stale | rowsUpdatedAt = 2024-12-03 (> 400d old) |
| annearundel-arcgis → Hosted/2040_Land_Use_Changes/LU2040 Consistency Changes | flag | layer "LU2040 Consistency Changes" is esriGeometryPolygon |
| annearundel-arcgis → Hosted/2040_Land_Use_Changes/LU2040 Consistency Changes Dissolved | flag | layer "LU2040 Consistency Changes Dissolved" is esriGeometryPolygon |
| annearundel-arcgis → Hosted/Development_Policy_Area_Overlays_PreliminaryDraft/Development_Policy_Area_Overlays_PreliminaryDraft | flag | layer "Development_Policy_Area_Overlays_PreliminaryDraft" is esriGeometryPolygon |
...
| annearundel-arcgis → Hosted/Development_Policy_Areas/Development Policy Areas | flag | layer "Development Policy Areas" is esriGeometryPolygon |
| annearundel-arcgis → Hosted/GDP_Land_Use_Plan2040_May_2023/GDP_LandUse_Plan_2040_Update2023_04252023 | flag | layer "GDP_LandUse_Plan_2040_Update2023_04252023" is esriGeometryPolygon |
| baltimore-county-dcat → Plumbing Permits | flag | fresh (newest 2026-07-14) |
| baltimore-county-dcat → Gas Permits | flag | fresh (newest 2026-07-16) |
| baltimore-county-dcat → Electrical Permits | flag | fresh (newest 2026-07-15) |
| baltimore-county-dcat → Use and Occupancy Permits | flag | fresh (newest 2026-07-16) but no lexicon status column among: OBJECTID, CASE_NUMBER, CA_TASK_ID, ADDRESSSTREETNUMBER, ADDRESSSTREETNAME, ADDRESSCITY, ADDRESSSTATE, ADDRESSZIP, PEOPLEROLEID, OWNERNAME, OWNERADDRESS1, OWNERADDRESS2, OWNERADDRESS3, OWNERCITY, OWNERSTATE |
| baltimore-county-dcat → Proposed Landuse | flag | layer "Proposed Land Use - Smart Code" is esriGeometryPolygon |
| baltimore-county-dcat → Landuse | flag | layer "Landuse" is esriGeometryPolygon |
| baltimore-county-dcat → Subdivisions | flag | layer "Subdivisions" is esriGeometryPolygon |
| baltimore-county-dcat → Regional Planning Districts | flag | layer "Regional Planning Districts" is esriGeometryPolygon |
| baltimore-county-dcat → Plats | flag | layer "Plats" is esriGeometryPolygon |
| frederick-county-dcat | unreachable | DCAT HTTP 404 {"error":"Domain record(s) not found :: A domain record with hostname = data-frederickcountymd.opendata.arcgis.com does not exist :: 404"} |
| harford-county-dcat | unreachable | DCAT HTTP 404 {"error":"Domain record(s) not found :: A domain record with hostname = data-harfordcountymd.opendata.arcgis.com does not exist :: 404"} |
...
- **baltimore-county-dcat → Proposed Landuse** — esriGeometryPolygon geometry: point-derivation (centroid) support in sources/arcgis.ts, or reject: intersection-style locations carry no parcel point
- **baltimore-county-dcat → Landuse** — esriGeometryPolygon geometry: point-derivation (centroid) support in sources/arcgis.ts, or reject: intersection-style locations carry no parcel point
- **baltimore-county-dcat → Subdivisions** — esriGeometryPolygon geometry: point-derivation (centroid) support in sources/arcgis.ts, or reject: intersection-style locations carry no parcel point
- **baltimore-county-dcat → Regional Planning Districts** — esriGeometryPolygon geometry: point-derivation (centroid) support in sources/arcgis.ts, or reject: intersection-style locations carry no parcel point
- **baltimore-county-dcat → Plats** — esriGeometryPolygon geometry: point-derivation (centroid) support in sources/arcgis.ts, or reject: intersection-style locations carry no parcel point
...
## Run 2026-07-18T08:47:56.805Z

- Sources re-probed: **18** · discovery targets walked: **44** · candidates evaluated: **197**
- Auto-wired: **none**
- Flagged new shapes (connector work needed — never guessed): **145**
- Dev-backed ZIPs snapshot: **1107** (Δ +26 vs last run)
...
| sandiego-county-arcgis | no-candidates | 61 services listed; none match the permit/land-use pattern |
| sanjose-ckan | flag | CKAN catalog with 7 permit-pattern dataset(s): Active Building Permits; Expired Building Permits; Last 30 days Planning Permits; Last 30 days building permits; Residential Parking Permit (RPP) Zones |
| santaclara-county-socrata → County of Santa Clara Permitted Body Art Facilities and Permitted Body Art Practitioners (mqx2-w62f) | flag | updated 2026-07-18; columns: facility_name, permit_type, site_address, city, zip, permitexpdate, facility_id, geo_address… |
| santaclara-county-socrata → County of Santa Clara Active Body Art Facilities and Permitted Body Art Practitioners (jwgu-xsep) | still-stale | rowsUpdatedAt = 2018-11-27 (> 400d old) |
| sunnyvale-arcgis-hub | unreachable | DCAT HTTP 0 UND_ERR_CONNECT_TIMEOUT |
| oakland-socrata → Residential Parking Permit Zones (su5x-2u99) | still-stale | rowsUpdatedAt = 2019-09-03 (> 400d old) |
| alameda-county-socrata | still-dead | catalog HTTP 404 <!DOCTYPE html>
...
| sonoma-county-socrata → Sonoma County Planning Permits (m689-iiuu) | flag | updated 2026-07-16; columns: file, status, application_type, started, address, description, parcel, sub_type… |
| sonoma-county-socrata → Sonoma County Rebuilding Permits (652y-5ihx) | flag | updated 2026-06-15; columns: record_id, date_opened, record_type, permit_status, category, permit_description, units, buildings, total_square_feet, situs_address, area_id, supervisors_district, event_title, first_inspection_date, parcel_number… |
| sonoma-county-socrata → Sonoma County Construction Permits (88ms-k5e7) | flag | updated 2026-07-17; columns: file_number, status, application_type, started, issued, address, description, assessors_parcel_number, totfee, value… |
| ventura-county-arcgis → DataDownloads/LandUse/Area plans | flag | layer "Area plans" is esriGeometryPolygon |
| ventura-county-arcgis → DataDownloads/LandUse/General Plan | flag | layer "General Plan" is esriGeometryPolygon |
| ventura-county-arcgis → DataDownloads/LandUse/Zone Designation | flag | layer "Zone Designation" is esriGeometryPolygon |
| ventura-county-arcgis → DataDownloads/LandUse/Area plans | flag | layer "Area plans" is esriGeometryPolygon |
...
| mesa-socrata → Turn Around Time - Permits (fhtq-vpmm) | flag | updated 2026-07-15; columns: record_id, customid, record_type, record_open_date, record_status, statusdate, task, istaskcompleted, assigneddate, taskstatus, duedate, actionbyuser, status_year, status_month, turnaroundtime… |
| mesa-socrata → Temporary Traffic Control (TTC) Permits (822f-avdk) | flag | updated 2026-07-16; columns: rownum, record_id, customid, company, company_name, businessname, address_line1, application_date, review_date, calendardays, days_in_review, plan_review_days, status_date, record_status, received_date… |
| mesa-socrata → Development Services - Permit Submittals and Resubmittals Logged In (kg7m-y6f3) | flag | updated 2026-07-17; columns: row_number, record_id, record_type, type_of_submittal, record_open_date, record_open_date_month, record_open_date_year, record_status, record_status_date, record_status_month, record_status_year, task, task_complete_flag, description, status… |
| mesa-socrata → Planning - Board of Adjustment (BOA) Memos completed (qmv6-zhfq) | flag | updated 2026-07-18; columns: rowid, record_id, record_type, submittal_date, submission_deadline_date, distributed_date, review_consolidation_date, formal_submittal_deadline_date, permit_description, record_open_date, record_status_date, record_status_month, record_status_year, record_status, task… |
| mesa-socrata → DSD - Planning & Zoning and Design Review Memos Completion (u5a9-tj5y) | flag | updated 2026-07-16; columns: rowid, record_id, record_type, permit_description, record_open_date, record_status_date, record_status, submission_deadline_date, distributed_date, formal_submittal_deadline_date, review_consolidation_date, task, task_status, record_status_month, record_status_year… |
| tempe-socrata | still-dead | catalog HTTP 404 <!DOCTYPE html>
<html lang="en">
<head>
...
| maricopa-county-arcgis → GIO/PermitHistory/Permit (Line) | flag | layer "Permit (Line)" is esriGeometryPolyline |
| maricopa-county-arcgis → GIO/PermitHistory/Permit (Polygon) | flag | layer "Permit (Polygon)" is esriGeometryPolygon |
| maricopa-county-arcgis → GIO/PermitHistory/Permit History (Point) | flag | fresh (newest 2026-07-17) but no lexicon status column among: OBJECTID, ModuleName, CaseID, CaseNumber, CaseType, WorkClass, ApplicationDate, ProjectID, ProjectName, GISHistoryQueueID, SpatialType, SpatialID |
| maricopa-county-arcgis → GIO/PermitHistory/Permit History (Line) | flag | layer "Permit History (Line)" is esriGeometryPolyline |
| maricopa-county-arcgis → GIO/PermitHistory/Permit History (Polygon) | flag | layer "Permit History (Polygon)" is esriGeometryPolygon |
| maricopa-county-arcgis → GIO/PermitHistory/Permit (Point) | flag | fresh (newest 2026-01-23) but no lexicon status column among: OBJECTID, Name, Description, CreatedDate, SHAPE |
| maricopa-county-arcgis → GIO/PermitHistory/Permit (Line) | flag | layer "Permit (Line)" is esriGeometryPolyline |
| maricopa-county-arcgis → GIO/PermitHistory/Permit (Polygon) | flag | layer "Permit (Polygon)" is esriGeometryPolygon |
| maricopa-county-arcgis → GIO/PermitHistory/Permit History (Point) | flag | fresh (newest 2026-07-17) but no lexicon status column among: OBJECTID, ModuleName, CaseID, CaseNumber, CaseType, WorkClass, ApplicationDate, ProjectID, ProjectName, GISHistoryQueueID, SpatialType, SpatialID, SHAPE |
| tucson-dcat → Zoning - Tucson - Open Data | flag | layer "ZONE_COT" is esriGeometryPolygon |
| tucson-dcat → Redevelopment Plans - Open Data | flag | layer "ZZ_PLAN_REDEV" is esriGeometryPolygon |
| tucson-dcat → Original City Zoning - Open Data | flag | layer "ZONE_OCZ" is esriGeometryPolygon |
| tucson-dcat → Subdivisions - Open Data | flag | layer "SUBDIV" is esriGeometryPolygon |
...
| montgomery-county-socrata → Mechanical Permits (ih88-a6aa) | flag | updated 2026-07-17; columns: permitno, status, stno, pre_direction, stname, suffix, postdir, city, state, zip, worktype, usecode, addeddate, issueddate, finaleddate… |
| montgomery-county-socrata → Electrical Building Permits (qxie-8qnp) | flag | updated 2026-07-17; columns: permitno, status, stno, predir, stname, suffix, postdir, city, state, zip, worktype, usecode, addeddate, issueddate, finaleddate… |
| montgomery-county-socrata → DPS - Antenna/Wireless Permits (djk9-h36c) | flag | updated 2026-07-18; columns: permit_number, permit_status, added_date, issue_date, final_date, tfcg_number, attachment_type, ozah, street_number, pre_direction, street_name, street_suffix, post_direction, city, state… |
| montgomery-county-socrata → Fence Permits (9quz-avmj) | flag | updated 2026-07-18; columns: application_type, permit_number, work_type, user_code, added_date, issue_date, final_date, expired_date, status, building_area, description_of_work, street_number, pre_direction, street_name, street_suffix… |
| montgomery-county-socrata → Sign Permits (piic-h4rw) | flag | updated 2026-07-18; columns: application_type, permit_no, work_type, use_code, added_date, issued_date, final_date, expired_date, status, building_area, description, st_no, pre_dir, st_name, suffix… |
| howard-county-socrata → Office of Consumer Protection Permits And Licenses (9rfk-bak7) | still-stale | rowsUpdatedAt = 2024-12-03 (> 400d old) |
| annearundel-arcgis → Hosted/2040_Land_Use_Changes/LU2040 Consistency Changes | flag | layer "LU2040 Consistency Changes" is esriGeometryPolygon |
| annearundel-arcgis → Hosted/2040_Land_Use_Changes/LU2040 Consistency Changes Dissolved | flag | layer "LU2040 Consistency Changes Dissolved" is esriGeometryPolygon |
| annearundel-arcgis → Hosted/Development_Policy_Area_Overlays_PreliminaryDraft/Development_Policy_Area_Overlays_PreliminaryDraft | flag | layer "Development_Policy_Area_Overlays_PreliminaryDraft" is esriGeometryPolygon |
...
| baltimore-county-dcat → Current CBCA Land Use Designation | flag | layer "Current CBCA Land Use Designation" is esriGeometryPolygon |
| baltimore-county-dcat → Zoning History | flag | layer "Zoning History Cases" is esriGeometryPolygon |
| baltimore-county-dcat → Plumbing Permits | flag | fresh (newest 2026-07-16) |
| baltimore-county-dcat → Gas Permits | flag | fresh (newest 2026-07-17) |
| baltimore-county-dcat → Electrical Permits | flag | fresh (newest 2026-07-15) |
| baltimore-county-dcat → Use and Occupancy Permits | flag | fresh (newest 2026-07-17) but no lexicon status column among: OBJECTID, CASE_NUMBER, CA_TASK_ID, ADDRESSSTREETNUMBER, ADDRESSSTREETNAME, ADDRESSCITY, ADDRESSSTATE, ADDRESSZIP, PEOPLEROLEID, OWNERNAME, OWNERADDRESS1, OWNERADDRESS2, OWNERADDRESS3, OWNERCITY, OWNERSTATE |
| baltimore-county-dcat → Proposed Landuse | flag | layer "Proposed Land Use - Smart Code" is esriGeometryPolygon |
| baltimore-county-dcat → Landuse | flag | layer "Landuse" is esriGeometryPolygon |
| frederick-county-dcat | unreachable | DCAT HTTP 404 {"error":"Domain record(s) not found :: A domain record with hostname = data-frederickcountymd.opendata.arcgis.com does not exist :: 404"} |
| harford-county-dcat | unreachable | DCAT HTTP 404 {"error":"Domain record(s) not found :: A domain record with hostname = data-harfordcountymd.opendata.arcgis.com does not exist :: 404"} |
...
| baltimore-city-dcat → Zoning | skipped | host baltegis.baltimorecity.gov not on the target allowlist |
| baltimore-city-dcat → Planning District | skipped | host baltegis.baltimorecity.gov not on the target allowlist |
| baltimore-city-dcat → Number of New Construction Permits per 1,000 Residential Properties | flag | layer "Number of New Construction Permits per 1,000 Residential Properties - Community Statistical Area" is esriGeometryPolygon |
| baltimore-city-dcat → Number of New Construction Permits per 1,000 Residential Properties - City | flag | layer "Number of New Construction Permits per 1,000 Residential Properties - City" is esriGeometryPolygon |
...
- **baltimore-city-dcat → Percent of Commercial Properties with Rehab Permits Above $5,000 - City** — esriGeometryPolygon geometry: point-derivation (centroid) support in sources/arcgis.ts, or reject: intersection-style locations carry no parcel point
- **baltimore-city-dcat → Residential Parking Permits** — esriGeometryPolygon geometry: point-derivation (centroid) support in sources/arcgis.ts, or reject: intersection-style locations carry no parcel point
- **baltimore-city-dcat → Number of New Construction Permits per 1,000 Residential Properties** — esriGeometryPolygon geometry: point-derivation (centroid) support in sources/arcgis.ts, or reject: intersection-style locations carry no parcel point
- **baltimore-city-dcat → Number of New Construction Permits per 1,000 Residential Properties - City** — esriGeometryPolygon geometry: point-derivation (centroid) support in sources/arcgis.ts, or reject: intersection-style locations carry no parcel point

## Run 2026-07-19T15:34:43.029Z

- Sources re-probed: **18** · discovery targets walked: **44** · candidates evaluated: **195**
- Auto-wired: **none**
- Flagged new shapes (connector work needed — never guessed): **140**
- Dev-backed ZIPs snapshot: **1110** (Δ +3 vs last run)
...
| denver-dcat → ODC DEV DEMOLITIONPERMIT P | flag | fresh (newest 2026-07-16) but no lexicon status column among: OBJECTID, DATE_ISSUED, PERMIT_NUM, ADDRESS, LOCATION, CLASS, UNITS, VALUATION, PERMIT_FEE, CONTRACTOR_NAME, FINAL_DATE, CANCEL, DATE_RECEIVED, BID_AUTHNAME, LOG_NUM |
| springs-gis-root → GeneralUse/EconomicDevelopment/Foreign Trade Zones | flag | layer "Foreign Trade Zones" is esriGeometryPolygon |
| springs-gis-root → GeneralUse/EconomicDevelopment/Urban Renewal Areas | flag | layer "Urban Renewal Areas" is esriGeometryPolygon |
| springs-gis-root → GeneralUse/EconomicDevelopment/Qualified Opportunity Zones | flag | layer "Qualified Opportunity Zones" is esriGeometryPolygon |
| springs-gis-root → GeneralUse/EconomicDevelopment/Commercial Aeronautical Zones | flag | layer "Commercial Aeronautical Zones" is esriGeometryPolygon |
...
| sandiego-county-arcgis | no-candidates | 61 services listed; none match the permit/land-use pattern |
| sanjose-ckan | flag | CKAN catalog with 7 permit-pattern dataset(s): Active Building Permits; Expired Building Permits; Last 30 days Planning Permits; Last 30 days building permits; Residential Parking Permit (RPP) Zones |
| santaclara-county-socrata → County of Santa Clara Permitted Body Art Facilities and Permitted Body Art Practitioners (mqx2-w62f) | flag | updated 2026-07-19; columns: facility_name, permit_type, site_address, city, zip, permitexpdate, facility_id, geo_address… |
| santaclara-county-socrata → County of Santa Clara Active Body Art Facilities and Permitted Body Art Practitioners (jwgu-xsep) | still-stale | rowsUpdatedAt = 2018-11-27 (> 400d old) |
| sunnyvale-arcgis-hub | unreachable | DCAT HTTP 0 UND_ERR_CONNECT_TIMEOUT |
| oakland-socrata → Residential Parking Permit Zones (su5x-2u99) | still-stale | rowsUpdatedAt = 2019-09-03 (> 400d old) |
| alameda-county-socrata | still-dead | catalog HTTP 404 <!DOCTYPE html>
...
| contracosta-county-arcgis → _Authoritative/Zoning/PLA_DCD_Zoning | flag | layer "PLA_DCD_Zoning" is esriGeometryPolygon |
| sonoma-county-socrata → Sonoma County Planning Permits (m689-iiuu) | flag | updated 2026-07-16; columns: file, status, application_type, started, address, description, parcel, sub_type… |
| sonoma-county-socrata → Sonoma County Rebuilding Permits (652y-5ihx) | flag | updated 2026-07-19; columns: record_id, date_opened, record_type, permit_status, category, permit_description, units, buildings, total_square_feet, situs_address, area_id, supervisors_district, event_title, first_inspection_date, parcel_number… |
| sonoma-county-socrata → Sonoma County Construction Permits (88ms-k5e7) | flag | updated 2026-07-19; columns: file_number, status, application_type, started, issued, address, description, assessors_parcel_number, totfee, value… |
| ventura-county-arcgis → DataDownloads/LandUse/Area plans | flag | layer "Area plans" is esriGeometryPolygon |
| ventura-county-arcgis → DataDownloads/LandUse/General Plan | flag | layer "General Plan" is esriGeometryPolygon |
| ventura-county-arcgis → DataDownloads/LandUse/Zone Designation | flag | layer "Zone Designation" is esriGeometryPolygon |
| ventura-county-arcgis → DataDownloads/LandUse/Area plans | flag | layer "Area plans" is esriGeometryPolygon |
...
| annearundel-arcgis → Hosted/GDP_Land_Use_Plan2040_May_2023/GDP_LandUse_Plan_2040_Update2023_04252023 | flag | layer "GDP_LandUse_Plan_2040_Update2023_04252023" is esriGeometryPolygon |
| baltimore-county-dcat → Active Development Search | no-candidates | no ArcGIS/Socrata distribution |
| baltimore-county-dcat → Current CBCA Land Use Designation | unreachable | HTTP 0 UND_ERR_CONNECT_TIMEOUT |
| baltimore-county-dcat → Zoning History | unreachable | HTTP 0 UND_ERR_CONNECT_TIMEOUT |
| baltimore-county-dcat → Plumbing Permits | unreachable | HTTP 200 non-JSON response |
| baltimore-county-dcat → Gas Permits | flag | fresh (newest 2026-07-17) |
| baltimore-county-dcat → Electrical Permits | flag | fresh (newest 2026-07-15) |
| baltimore-county-dcat → Use and Occupancy Permits | flag | fresh (newest 2026-07-17) but no lexicon status column among: OBJECTID, CASE_NUMBER, CA_TASK_ID, ADDRESSSTREETNUMBER, ADDRESSSTREETNAME, ADDRESSCITY, ADDRESSSTATE, ADDRESSZIP, PEOPLEROLEID, OWNERNAME, OWNERADDRESS1, OWNERADDRESS2, OWNERADDRESS3, OWNERCITY, OWNERSTATE |
| baltimore-county-dcat → Proposed Landuse | flag | layer "Proposed Land Use - Smart Code" is esriGeometryPolygon |
...
- **denver-dcat → ODC DEV DEMOLITIONPERMIT P** — no status column: a human to map the status semantics (San Antonio-style dataset-level status needs a judgment call)
- **springs-gis-root → GeneralUse/EconomicDevelopment/Foreign Trade Zones** — esriGeometryPolygon geometry: point-derivation (centroid) support in sources/arcgis.ts, or reject: intersection-style locations carry no parcel point
- **springs-gis-root → GeneralUse/EconomicDevelopment/Urban Renewal Areas** — esriGeometryPolygon geometry: point-derivation (centroid) support in sources/arcgis.ts, or reject: intersection-style locations carry no parcel point
- **springs-gis-root → GeneralUse/EconomicDevelopment/Qualified Opportunity Zones** — esriGeometryPolygon geometry: point-derivation (centroid) support in sources/arcgis.ts, or reject: intersection-style locations carry no parcel point
- **springs-gis-root → GeneralUse/EconomicDevelopment/Commercial Aeronautical Zones** — esriGeometryPolygon geometry: point-derivation (centroid) support in sources/arcgis.ts, or reject: intersection-style locations carry no parcel point
...
## Run 2026-07-20T10:10:14.147Z

- Sources re-probed: **18** · discovery targets walked: **44** · candidates evaluated: **195**
- Auto-wired: **none**
- Flagged new shapes (connector work needed — never guessed): **143**
- Dev-backed ZIPs snapshot: **1110** (Δ +0 vs last run)
...
| sandiego-county-arcgis | no-candidates | 61 services listed; none match the permit/land-use pattern |
| sanjose-ckan | flag | CKAN catalog with 7 permit-pattern dataset(s): Active Building Permits; Expired Building Permits; Last 30 days Planning Permits; Last 30 days building permits; Residential Parking Permit (RPP) Zones |
| santaclara-county-socrata → County of Santa Clara Permitted Body Art Facilities and Permitted Body Art Practitioners (mqx2-w62f) | flag | updated 2026-07-20; columns: facility_name, permit_type, site_address, city, zip, permitexpdate, facility_id, geo_address… |
| santaclara-county-socrata → County of Santa Clara Active Body Art Facilities and Permitted Body Art Practitioners (jwgu-xsep) | still-stale | rowsUpdatedAt = 2018-11-27 (> 400d old) |
| sunnyvale-arcgis-hub | unreachable | DCAT HTTP 0 UND_ERR_CONNECT_TIMEOUT |
| oakland-socrata → Residential Parking Permit Zones (su5x-2u99) | still-stale | rowsUpdatedAt = 2019-09-03 (> 400d old) |
| alameda-county-socrata | still-dead | catalog HTTP 404 <!DOCTYPE html>
...
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http |
| montgomery-county-socrata → Mechanical Permits (ih88-a6aa) | flag | updated 2026-07-20; columns: permitno, status, stno, pre_direction, stname, suffix, postdir, city, state, zip, worktype, usecode, addeddate, issueddate, finaleddate… |
| montgomery-county-socrata → Electrical Building Permits (qxie-8qnp) | flag | updated 2026-07-20; columns: permitno, status, stno, predir, stname, suffix, postdir, city, state, zip, worktype, usecode, addeddate, issueddate, finaleddate… |
| montgomery-county-socrata → DPS - Antenna/Wireless Permits (djk9-h36c) | flag | updated 2026-07-20; columns: permit_number, permit_status, added_date, issue_date, final_date, tfcg_number, attachment_type, ozah, street_number, pre_direction, street_name, street_suffix, post_direction, city, state… |
| montgomery-county-socrata → Fence Permits (9quz-avmj) | flag | updated 2026-07-18; columns: application_type, permit_number, work_type, user_code, added_date, issue_date, final_date, expired_date, status, building_area, description_of_work, street_number, pre_direction, street_name, street_suffix… |
| montgomery-county-socrata → Sign Permits (piic-h4rw) | flag | updated 2026-07-18; columns: application_type, permit_no, work_type, use_code, added_date, issued_date, final_date, expired_date, status, building_area, description, st_no, pre_dir, st_name, suffix… |
| howard-county-socrata → Office of Consumer Protection Permits And Licenses (9rfk-bak7) | still-stale | rowsUpdatedAt = 2024-12-03 (> 400d old) |
| annearundel-arcgis → Hosted/2040_Land_Use_Changes/LU2040 Consistency Changes | flag | layer "LU2040 Consistency Changes" is esriGeometryPolygon |
...
## Run 2026-07-21T09:26:39.902Z

- Sources re-probed: **18** · discovery targets walked: **44** · candidates evaluated: **186**
- Auto-wired: **none**
- Flagged new shapes (connector work needed — never guessed): **137**
- Dev-backed ZIPs snapshot: **1110** (Δ +0 vs last run)

| target | result | evidence |
|---|---|---|
| denton-county-dev-permits | unreachable | HTTP 522 <!DOCTYPE html>
...
| mckinney-arcgis → MapServices/FireStation14PlanningDriveTimes/Drive Time Areas 1 | flag | layer "Drive Time Areas 1" is esriGeometryPolygon |
| mckinney-arcgis → MapServices/FireStation14PlanningDriveTimes/Drive Times 2 | not-a-layer | no fields[] — unrecognized shape |
| denton-county-arcgis | unreachable | root HTTP 522 <!DOCTYPE html>
<!--[if lt IE 7]> <html class="no-js ie6 oldie" lang="en-US"> <![endif]-->
<!--[if IE 7]>    <html class="no-js ie7 oldie" lang="en-US"> <![endif]-->
<!--[if IE 8]>    <html class="no- |
| jeffco-dcat → Zoning | flag | layer "Zoning" is esriGeometryPolygon |
...
| sandiego-county-arcgis | no-candidates | 61 services listed; none match the permit/land-use pattern |
| sanjose-ckan | flag | CKAN catalog with 7 permit-pattern dataset(s): Active Building Permits; Expired Building Permits; Last 30 days Planning Permits; Last 30 days building permits; Residential Parking Permit (RPP) Zones |
| santaclara-county-socrata → County of Santa Clara Permitted Body Art Facilities and Permitted Body Art Practitioners (mqx2-w62f) | flag | updated 2026-07-21; columns: facility_name, permit_type, site_address, city, zip, permitexpdate, facility_id, geo_address… |
| santaclara-county-socrata → County of Santa Clara Active Body Art Facilities and Permitted Body Art Practitioners (jwgu-xsep) | still-stale | rowsUpdatedAt = 2018-11-27 (> 400d old) |
| sunnyvale-arcgis-hub | unreachable | DCAT HTTP 0 UND_ERR_CONNECT_TIMEOUT |
| oakland-socrata → Residential Parking Permit Zones (su5x-2u99) | still-stale | rowsUpdatedAt = 2019-09-03 (> 400d old) |
| alameda-county-socrata | still-dead | catalog HTTP 404 <!DOCTYPE html>
...
| contracosta-county-arcgis → _Authoritative/Zoning/PLA_DCD_Zoning | flag | layer "PLA_DCD_Zoning" is esriGeometryPolygon |
| contracosta-county-arcgis → _Authoritative/Zoning/PLA_DCD_Zoning | flag | layer "PLA_DCD_Zoning" is esriGeometryPolygon |
| sonoma-county-socrata → Sonoma County Planning Permits (m689-iiuu) | flag | updated 2026-07-20; columns: file, status, application_type, started, address, description, parcel, sub_type… |
| sonoma-county-socrata → Sonoma County Rebuilding Permits (652y-5ihx) | flag | updated 2026-07-20; columns: record_id, date_opened, record_type, permit_status, category, permit_description, units, buildings, total_square_feet, situs_address, area_id, supervisors_district, event_title, first_inspection_date, parcel_number… |
| sonoma-county-socrata → Sonoma County Construction Permits (88ms-k5e7) | flag | updated 2026-07-20; columns: file_number, status, application_type, started, issued, address, description, assessors_parcel_number, totfee, value… |
| ventura-county-arcgis → DataDownloads/LandUse/Area plans | flag | layer "Area plans" is esriGeometryPolygon |
| ventura-county-arcgis → DataDownloads/LandUse/General Plan | flag | layer "General Plan" is esriGeometryPolygon |
| ventura-county-arcgis → DataDownloads/LandUse/Zone Designation | flag | layer "Zone Designation" is esriGeometryPolygon |
| ventura-county-arcgis → DataDownloads/LandUse/Area plans | flag | layer "Area plans" is esriGeometryPolygon |
...
| maricopa-county-arcgis → GIO/PermitHistory/Permit (Line) | flag | layer "Permit (Line)" is esriGeometryPolyline |
| maricopa-county-arcgis → GIO/PermitHistory/Permit (Polygon) | flag | layer "Permit (Polygon)" is esriGeometryPolygon |
| maricopa-county-arcgis → GIO/PermitHistory/Permit History (Point) | flag | fresh (newest 2026-07-20) but no lexicon status column among: OBJECTID, ModuleName, CaseID, CaseNumber, CaseType, WorkClass, ApplicationDate, ProjectID, ProjectName, GISHistoryQueueID, SpatialType, SpatialID |
| maricopa-county-arcgis → GIO/PermitHistory/Permit History (Line) | flag | layer "Permit History (Line)" is esriGeometryPolyline |
| maricopa-county-arcgis → GIO/PermitHistory/Permit History (Polygon) | flag | layer "Permit History (Polygon)" is esriGeometryPolygon |
| maricopa-county-arcgis → GIO/PermitHistory/Permit (Point) | flag | fresh (newest 2026-01-23) but no lexicon status column among: OBJECTID, Name, Description, CreatedDate, SHAPE |
| maricopa-county-arcgis → GIO/PermitHistory/Permit (Line) | flag | layer "Permit (Line)" is esriGeometryPolyline |
| maricopa-county-arcgis → GIO/PermitHistory/Permit (Polygon) | flag | layer "Permit (Polygon)" is esriGeometryPolygon |
| maricopa-county-arcgis → GIO/PermitHistory/Permit History (Point) | flag | fresh (newest 2026-07-20) but no lexicon status column among: OBJECTID, ModuleName, CaseID, CaseNumber, CaseType, WorkClass, ApplicationDate, ProjectID, ProjectName, GISHistoryQueueID, SpatialType, SpatialID, SHAPE |
| tucson-dcat → Zoning - Tucson - Open Data | flag | layer "ZONE_COT" is esriGeometryPolygon |
| tucson-dcat → Redevelopment Plans - Open Data | flag | layer "ZZ_PLAN_REDEV" is esriGeometryPolygon |
| tucson-dcat → Original City Zoning - Open Data | flag | layer "ZONE_OCZ" is esriGeometryPolygon |
| tucson-dcat → Subdivisions - Open Data | flag | layer "SUBDIV" is esriGeometryPolygon |
...
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http |
| montgomery-county-socrata → Mechanical Permits (ih88-a6aa) | flag | updated 2026-07-21; columns: permitno, status, stno, pre_direction, stname, suffix, postdir, city, state, zip, worktype, usecode, addeddate, issueddate, finaleddate… |
| montgomery-county-socrata → Electrical Building Permits (qxie-8qnp) | flag | updated 2026-07-21; columns: permitno, status, stno, predir, stname, suffix, postdir, city, state, zip, worktype, usecode, addeddate, issueddate, finaleddate… |
| montgomery-county-socrata → DPS - Antenna/Wireless Permits (djk9-h36c) | flag | updated 2026-07-20; columns: permit_number, permit_status, added_date, issue_date, final_date, tfcg_number, attachment_type, ozah, street_number, pre_direction, street_name, street_suffix, post_direction, city, state… |
| montgomery-county-socrata → Fence Permits (9quz-avmj) | flag | updated 2026-07-18; columns: application_type, permit_number, work_type, user_code, added_date, issue_date, final_date, expired_date, status, building_area, description_of_work, street_number, pre_direction, street_name, street_suffix… |
| montgomery-county-socrata → Sign Permits (piic-h4rw) | flag | updated 2026-07-21; columns: application_type, permit_no, work_type, use_code, added_date, issued_date, final_date, expired_date, status, building_area, description, st_no, pre_dir, st_name, suffix… |
| howard-county-socrata → Office of Consumer Protection Permits And Licenses (9rfk-bak7) | still-stale | rowsUpdatedAt = 2024-12-03 (> 400d old) |
| annearundel-arcgis → Hosted/2040_Land_Use_Changes/LU2040 Consistency Changes | flag | layer "LU2040 Consistency Changes" is esriGeometryPolygon |
| annearundel-arcgis → Hosted/2040_Land_Use_Changes/LU2040 Consistency Changes Dissolved | flag | layer "LU2040 Consistency Changes Dissolved" is esriGeometryPolygon |
| annearundel-arcgis → Hosted/Development_Policy_Area_Overlays_PreliminaryDraft/Development_Policy_Area_Overlays_PreliminaryDraft | flag | layer "Development_Policy_Area_Overlays_PreliminaryDraft" is esriGeometryPolygon |
...
| annearundel-arcgis → Hosted/GDP_Land_Use_Plan2040_May_2023/GDP_LandUse_Plan_2040_Update2023_04252023 | flag | layer "GDP_LandUse_Plan_2040_Update2023_04252023" is esriGeometryPolygon |
| baltimore-county-dcat → Plumbing Permits | flag | fresh (newest 2026-07-16) |
| baltimore-county-dcat → Gas Permits | flag | fresh (newest 2026-07-20) |
| baltimore-county-dcat → Electrical Permits | flag | fresh (newest 2026-07-17) |
| baltimore-county-dcat → Use and Occupancy Permits | flag | fresh (newest 2026-07-20) but no lexicon status column among: OBJECTID, CASE_NUMBER, CA_TASK_ID, ADDRESSSTREETNUMBER, ADDRESSSTREETNAME, ADDRESSCITY, ADDRESSSTATE, ADDRESSZIP, PEOPLEROLEID, OWNERNAME, OWNERADDRESS1, OWNERADDRESS2, OWNERADDRESS3, OWNERCITY, OWNERSTATE |
| baltimore-county-dcat → Proposed Landuse | flag | layer "Proposed Land Use - Smart Code" is esriGeometryPolygon |
| baltimore-county-dcat → Landuse | flag | layer "Landuse" is esriGeometryPolygon |
| baltimore-county-dcat → Subdivisions | flag | layer "Subdivisions" is esriGeometryPolygon |
| baltimore-county-dcat → Regional Planning Districts | flag | layer "Regional Planning Districts" is esriGeometryPolygon |
...
| sandiego-county-arcgis | no-candidates | 61 services listed; none match the permit/land-use pattern |
| sanjose-ckan | flag | CKAN catalog with 7 permit-pattern dataset(s): Active Building Permits; Expired Building Permits; Last 30 days Planning Permits; Last 30 days building permits; Residential Parking Permit (RPP) Zones |
| santaclara-county-socrata → County of Santa Clara Permitted Body Art Facilities and Permitted Body Art Practitioners (mqx2-w62f) | flag | updated 2026-07-22; columns: facility_name, permit_type, site_address, city, zip, permitexpdate, facility_id, geo_address… |
| santaclara-county-socrata → County of Santa Clara Active Body Art Facilities and Permitted Body Art Practitioners (jwgu-xsep) | still-stale | rowsUpdatedAt = 2018-11-27 (> 400d old) |
| sunnyvale-arcgis-hub | unreachable | DCAT HTTP 0 UND_ERR_CONNECT_TIMEOUT |
| oakland-socrata → Residential Parking Permit Zones (su5x-2u99) | still-stale | rowsUpdatedAt = 2019-09-03 (> 400d old) |
| alameda-county-socrata | still-dead | catalog HTTP 404 <!DOCTYPE html>
...
| contracosta-county-arcgis → _Authoritative/Zoning/PLA_DCD_Zoning | flag | layer "PLA_DCD_Zoning" is esriGeometryPolygon |
| contracosta-county-arcgis → _Authoritative/Zoning/PLA_DCD_Zoning | flag | layer "PLA_DCD_Zoning" is esriGeometryPolygon |
| sonoma-county-socrata → Sonoma County Planning Permits (m689-iiuu) | flag | updated 2026-07-21; columns: file, status, application_type, started, address, description, parcel, sub_type… |
| sonoma-county-socrata → Sonoma County Rebuilding Permits (652y-5ihx) | flag | updated 2026-07-20; columns: record_id, date_opened, record_type, permit_status, category, permit_description, units, buildings, total_square_feet, situs_address, area_id, supervisors_district, event_title, first_inspection_date, parcel_number… |
| sonoma-county-socrata → Sonoma County Construction Permits (88ms-k5e7) | flag | updated 2026-07-21; columns: file_number, status, application_type, started, issued, address, description, assessors_parcel_number, totfee, value… |
| ventura-county-arcgis → DataDownloads/LandUse/Area plans | flag | layer "Area plans" is esriGeometryPolygon |
| ventura-county-arcgis → DataDownloads/LandUse/General Plan | flag | layer "General Plan" is esriGeometryPolygon |
| ventura-county-arcgis → DataDownloads/LandUse/Zone Designation | flag | layer "Zone Designation" is esriGeometryPolygon |
| ventura-county-arcgis → DataDownloads/LandUse/Area plans | flag | layer "Area plans" is esriGeometryPolygon |
...
| maricopa-county-arcgis → GIO/PermitHistory/Permit (Line) | flag | layer "Permit (Line)" is esriGeometryPolyline |
| maricopa-county-arcgis → GIO/PermitHistory/Permit (Polygon) | flag | layer "Permit (Polygon)" is esriGeometryPolygon |
| maricopa-county-arcgis → GIO/PermitHistory/Permit History (Point) | flag | fresh (newest 2026-07-21) but no lexicon status column among: OBJECTID, ModuleName, CaseID, CaseNumber, CaseType, WorkClass, ApplicationDate, ProjectID, ProjectName, GISHistoryQueueID, SpatialType, SpatialID |
| maricopa-county-arcgis → GIO/PermitHistory/Permit History (Line) | flag | layer "Permit History (Line)" is esriGeometryPolyline |
| maricopa-county-arcgis → GIO/PermitHistory/Permit History (Polygon) | flag | layer "Permit History (Polygon)" is esriGeometryPolygon |
| maricopa-county-arcgis → GIO/PermitHistory/Permit (Point) | flag | fresh (newest 2026-01-23) but no lexicon status column among: OBJECTID, Name, Description, CreatedDate, SHAPE |
| maricopa-county-arcgis → GIO/PermitHistory/Permit (Line) | flag | layer "Permit (Line)" is esriGeometryPolyline |
| maricopa-county-arcgis → GIO/PermitHistory/Permit (Polygon) | flag | layer "Permit (Polygon)" is esriGeometryPolygon |
| maricopa-county-arcgis → GIO/PermitHistory/Permit History (Point) | flag | fresh (newest 2026-07-21) but no lexicon status column among: OBJECTID, ModuleName, CaseID, CaseNumber, CaseType, WorkClass, ApplicationDate, ProjectID, ProjectName, GISHistoryQueueID, SpatialType, SpatialID, SHAPE |
| tucson-dcat → Zoning - Tucson - Open Data | flag | layer "ZONE_COT" is esriGeometryPolygon |
| tucson-dcat → Redevelopment Plans - Open Data | flag | layer "ZZ_PLAN_REDEV" is esriGeometryPolygon |
| tucson-dcat → Original City Zoning - Open Data | flag | layer "ZONE_OCZ" is esriGeometryPolygon |
| tucson-dcat → Subdivisions - Open Data | flag | layer "SUBDIV" is esriGeometryPolygon |
...
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http |
| montgomery-county-socrata → Mechanical Permits (ih88-a6aa) | flag | updated 2026-07-22; columns: permitno, status, stno, pre_direction, stname, suffix, postdir, city, state, zip, worktype, usecode, addeddate, issueddate, finaleddate… |
| montgomery-county-socrata → Electrical Building Permits (qxie-8qnp) | flag | updated 2026-07-22; columns: permitno, status, stno, predir, stname, suffix, postdir, city, state, zip, worktype, usecode, addeddate, issueddate, finaleddate… |
| montgomery-county-socrata → DPS - Antenna/Wireless Permits (djk9-h36c) | flag | updated 2026-07-22; columns: permit_number, permit_status, added_date, issue_date, final_date, tfcg_number, attachment_type, ozah, street_number, pre_direction, street_name, street_suffix, post_direction, city, state… |
| montgomery-county-socrata → Fence Permits (9quz-avmj) | flag | updated 2026-07-22; columns: application_type, permit_number, work_type, user_code, added_date, issue_date, final_date, expired_date, status, building_area, description_of_work, street_number, pre_direction, street_name, street_suffix… |
| montgomery-county-socrata → Sign Permits (piic-h4rw) | flag | updated 2026-07-22; columns: application_type, permit_no, work_type, use_code, added_date, issued_date, final_date, expired_date, status, building_area, description, st_no, pre_dir, st_name, suffix… |
| howard-county-socrata → Office of Consumer Protection Permits And Licenses (9rfk-bak7) | still-stale | rowsUpdatedAt = 2024-12-03 (> 400d old) |
| annearundel-arcgis → Hosted/2040_Land_Use_Changes/LU2040 Consistency Changes | flag | layer "LU2040 Consistency Changes" is esriGeometryPolygon |
| annearundel-arcgis → Hosted/2040_Land_Use_Changes/LU2040 Consistency Changes Dissolved | flag | layer "LU2040 Consistency Changes Dissolved" is esriGeometryPolygon |
| annearundel-arcgis → Hosted/Development_Policy_Area_Overlays_PreliminaryDraft/Development_Policy_Area_Overlays_PreliminaryDraft | flag | layer "Development_Policy_Area_Overlays_PreliminaryDraft" is esriGeometryPolygon |
...
| annearundel-arcgis → Hosted/Development_Policy_Areas/Development Policy Areas | flag | layer "Development Policy Areas" is esriGeometryPolygon |
| annearundel-arcgis → Hosted/GDP_Land_Use_Plan2040_May_2023/GDP_LandUse_Plan_2040_Update2023_04252023 | flag | layer "GDP_LandUse_Plan_2040_Update2023_04252023" is esriGeometryPolygon |
| baltimore-county-dcat → Plumbing Permits | flag | fresh (newest 2026-07-20) |
| baltimore-county-dcat → Gas Permits | flag | fresh (newest 2026-07-21) |
| baltimore-county-dcat → Electrical Permits | flag | fresh (newest 2026-07-21) |
| baltimore-county-dcat → Use and Occupancy Permits | flag | fresh (newest 2026-07-21) but no lexicon status column among: OBJECTID, CASE_NUMBER, CA_TASK_ID, ADDRESSSTREETNUMBER, ADDRESSSTREETNAME, ADDRESSCITY, ADDRESSSTATE, ADDRESSZIP, PEOPLEROLEID, OWNERNAME, OWNERADDRESS1, OWNERADDRESS2, OWNERADDRESS3, OWNERCITY, OWNERSTATE |
| baltimore-county-dcat → Proposed Landuse | flag | layer "Proposed Land Use - Smart Code" is esriGeometryPolygon |
| baltimore-county-dcat → Landuse | flag | layer "Landuse" is esriGeometryPolygon |
| baltimore-county-dcat → Subdivisions | flag | layer "Subdivisions" is esriGeometryPolygon |
| baltimore-county-dcat → Regional Planning Districts | flag | layer "Regional Planning Districts" is esriGeometryPolygon |
...
## Run 2026-07-23T09:24:02.029Z

- Sources re-probed: **18** · discovery targets walked: **44** · candidates evaluated: **197**
- Auto-wired: **none**
- Flagged new shapes (connector work needed — never guessed): **146**
- Dev-backed ZIPs snapshot: **1132** (Δ +22 vs last run)
...
| sandiego-county-arcgis | no-candidates | 61 services listed; none match the permit/land-use pattern |
| sanjose-ckan | flag | CKAN catalog with 7 permit-pattern dataset(s): Active Building Permits; Expired Building Permits; Last 30 days Planning Permits; Last 30 days building permits; Residential Parking Permit (RPP) Zones |
| santaclara-county-socrata → County of Santa Clara Permitted Body Art Facilities and Permitted Body Art Practitioners (mqx2-w62f) | flag | updated 2026-07-23; columns: facility_name, permit_type, site_address, city, zip, permitexpdate, facility_id, geo_address… |
| santaclara-county-socrata → County of Santa Clara Active Body Art Facilities and Permitted Body Art Practitioners (jwgu-xsep) | still-stale | rowsUpdatedAt = 2018-11-27 (> 400d old) |
| sunnyvale-arcgis-hub | unreachable | DCAT HTTP 0 UND_ERR_CONNECT_TIMEOUT |
| oakland-socrata → Residential Parking Permit Zones (su5x-2u99) | still-stale | rowsUpdatedAt = 2019-09-03 (> 400d old) |
| alameda-county-socrata | still-dead | catalog HTTP 404 <!DOCTYPE html>
...
| sonoma-county-socrata → Sonoma County Planning Permits (m689-iiuu) | flag | updated 2026-07-21; columns: file, status, application_type, started, address, description, parcel, sub_type… |
| sonoma-county-socrata → Sonoma County Rebuilding Permits (652y-5ihx) | flag | updated 2026-07-20; columns: record_id, date_opened, record_type, permit_status, category, permit_description, units, buildings, total_square_feet, situs_address, area_id, supervisors_district, event_title, first_inspection_date, parcel_number… |
| sonoma-county-socrata → Sonoma County Construction Permits (88ms-k5e7) | flag | updated 2026-07-22; columns: file_number, status, application_type, started, issued, address, description, assessors_parcel_number, totfee, value… |
| ventura-county-arcgis → DataDownloads/LandUse/Area plans | flag | layer "Area plans" is esriGeometryPolygon |
| ventura-county-arcgis → DataDownloads/LandUse/General Plan | flag | layer "General Plan" is esriGeometryPolygon |
| ventura-county-arcgis → DataDownloads/LandUse/Zone Designation | flag | layer "Zone Designation" is esriGeometryPolygon |
| ventura-county-arcgis → DataDownloads/LandUse/Area plans | flag | layer "Area plans" is esriGeometryPolygon |
...
| phoenix-ckan | flag | CKAN catalog with 2 permit-pattern dataset(s): Phoenix, AZ Building Permit Data; Proposed Zoning |
| mesa-socrata → Building Permits (RETIRED) (2gkz-7z4f) | flag | updated 2026-01-07; columns: rowid, permit_number, property_address, street_number, street_direction, street_name, street_type, unit_number, council_district, issued_date, issued_year, issued_month, finaled_date, finaled_year, finaled_month… |
| mesa-socrata → Turn Around Time - Permits (fhtq-vpmm) | flag | updated 2026-07-22; columns: record_id, customid, record_type, record_open_date, record_status, statusdate, task, istaskcompleted, assigneddate, taskstatus, duedate, actionbyuser, status_year, status_month, turnaroundtime… |
| mesa-socrata → Temporary Traffic Control (TTC) Permits (822f-avdk) | flag | updated 2026-07-23; columns: rownum, record_id, customid, company, company_name, businessname, address_line1, application_date, review_date, calendardays, days_in_review, plan_review_days, status_date, record_status, received_date… |
| mesa-socrata → Development Services - Permit Submittals and Resubmittals Logged In (kg7m-y6f3) | flag | updated 2026-07-22; columns: row_number, record_id, record_type, type_of_submittal, record_open_date, record_open_date_month, record_open_date_year, record_status, record_status_date, record_status_month, record_status_year, task, task_complete_flag, description, status… |
| mesa-socrata → Planning - Board of Adjustment (BOA) Memos completed (qmv6-zhfq) | flag | updated 2026-07-18; columns: rowid, record_id, record_type, submittal_date, submission_deadline_date, distributed_date, review_consolidation_date, formal_submittal_deadline_date, permit_description, record_open_date, record_status_date, record_status_month, record_status_year, record_status, task… |
| mesa-socrata → DSD - Planning & Zoning and Design Review Memos Completion (u5a9-tj5y) | flag | updated 2026-07-23; columns: rowid, record_id, record_type, permit_description, record_open_date, record_status_date, record_status, submission_deadline_date, distributed_date, formal_submittal_deadline_date, review_consolidation_date, task, task_status, record_status_month, record_status_year… |
| tempe-socrata | still-dead | catalog HTTP 404 <!DOCTYPE html>
<html lang="en">
<head>
<meta charset="utf-8">
...
| maricopa-county-arcgis → GIO/PermitHistory/Permit (Line) | flag | layer "Permit (Line)" is esriGeometryPolyline |
| maricopa-county-arcgis → GIO/PermitHistory/Permit (Polygon) | flag | layer "Permit (Polygon)" is esriGeometryPolygon |
| maricopa-county-arcgis → GIO/PermitHistory/Permit History (Point) | flag | fresh (newest 2026-07-22) but no lexicon status column among: OBJECTID, ModuleName, CaseID, CaseNumber, CaseType, WorkClass, ApplicationDate, ProjectID, ProjectName, GISHistoryQueueID, SpatialType, SpatialID |
| maricopa-county-arcgis → GIO/PermitHistory/Permit History (Line) | flag | layer "Permit History (Line)" is esriGeometryPolyline |
| maricopa-county-arcgis → GIO/PermitHistory/Permit History (Polygon) | flag | layer "Permit History (Polygon)" is esriGeometryPolygon |
| maricopa-county-arcgis → GIO/PermitHistory/Permit (Point) | flag | fresh (newest 2026-01-23) but no lexicon status column among: OBJECTID, Name, Description, CreatedDate, SHAPE |
| maricopa-county-arcgis → GIO/PermitHistory/Permit (Line) | flag | layer "Permit (Line)" is esriGeometryPolyline |
| maricopa-county-arcgis → GIO/PermitHistory/Permit (Polygon) | flag | layer "Permit (Polygon)" is esriGeometryPolygon |
| maricopa-county-arcgis → GIO/PermitHistory/Permit History (Point) | flag | fresh (newest 2026-07-22) but no lexicon status column among: OBJECTID, ModuleName, CaseID, CaseNumber, CaseType, WorkClass, ApplicationDate, ProjectID, ProjectName, GISHistoryQueueID, SpatialType, SpatialID, SHAPE |
| tucson-dcat → Zoning - Tucson - Open Data | flag | layer "ZONE_COT" is esriGeometryPolygon |
| tucson-dcat → Redevelopment Plans - Open Data | flag | layer "ZZ_PLAN_REDEV" is esriGeometryPolygon |
| tucson-dcat → Original City Zoning - Open Data | flag | layer "ZONE_OCZ" is esriGeometryPolygon |
| tucson-dcat → Subdivisions - Open Data | flag | layer "SUBDIV" is esriGeometryPolygon |
...
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http |
| montgomery-county-socrata → Mechanical Permits (ih88-a6aa) | flag | updated 2026-07-23; columns: permitno, status, stno, pre_direction, stname, suffix, postdir, city, state, zip, worktype, usecode, addeddate, issueddate, finaleddate… |
| montgomery-county-socrata → Electrical Building Permits (qxie-8qnp) | flag | updated 2026-07-23; columns: permitno, status, stno, predir, stname, suffix, postdir, city, state, zip, worktype, usecode, addeddate, issueddate, finaleddate… |
| montgomery-county-socrata → DPS - Antenna/Wireless Permits (djk9-h36c) | flag | updated 2026-07-23; columns: permit_number, permit_status, added_date, issue_date, final_date, tfcg_number, attachment_type, ozah, street_number, pre_direction, street_name, street_suffix, post_direction, city, state… |
| montgomery-county-socrata → Fence Permits (9quz-avmj) | flag | updated 2026-07-23; columns: application_type, permit_number, work_type, user_code, added_date, issue_date, final_date, expired_date, status, building_area, description_of_work, street_number, pre_direction, street_name, street_suffix… |
| montgomery-county-socrata → Sign Permits (piic-h4rw) | flag | updated 2026-07-22; columns: application_type, permit_no, work_type, use_code, added_date, issued_date, final_date, expired_date, status, building_area, description, st_no, pre_dir, st_name, suffix… |
| howard-county-socrata → Office of Consumer Protection Permits And Licenses (9rfk-bak7) | still-stale | rowsUpdatedAt = 2024-12-03 (> 400d old) |
| annearundel-arcgis → Hosted/2040_Land_Use_Changes/LU2040 Consistency Changes | flag | layer "LU2040 Consistency Changes" is esriGeometryPolygon |
| annearundel-arcgis → Hosted/2040_Land_Use_Changes/LU2040 Consistency Changes Dissolved | flag | layer "LU2040 Consistency Changes Dissolved" is esriGeometryPolygon |
...
| baltimore-county-dcat → Current CBCA Land Use Designation | flag | layer "Current CBCA Land Use Designation" is esriGeometryPolygon |
| baltimore-county-dcat → Zoning History | flag | layer "Zoning History Cases" is esriGeometryPolygon |
| baltimore-county-dcat → Plumbing Permits | flag | fresh (newest 2026-07-21) |
| baltimore-county-dcat → Gas Permits | flag | fresh (newest 2026-07-22) |
| baltimore-county-dcat → Electrical Permits | flag | fresh (newest 2026-07-21) |
| baltimore-county-dcat → Use and Occupancy Permits | flag | fresh (newest 2026-07-22) but no lexicon status column among: OBJECTID, CASE_NUMBER, CA_TASK_ID, ADDRESSSTREETNUMBER, ADDRESSSTREETNAME, ADDRESSCITY, ADDRESSSTATE, ADDRESSZIP, PEOPLEROLEID, OWNERNAME, OWNERADDRESS1, OWNERADDRESS2, OWNERADDRESS3, OWNERCITY, OWNERSTATE |
| baltimore-county-dcat → Proposed Landuse | flag | layer "Proposed Land Use - Smart Code" is esriGeometryPolygon |
| baltimore-county-dcat → Landuse | flag | layer "Landuse" is esriGeometryPolygon |
| frederick-county-dcat | unreachable | DCAT HTTP 404 {"error":"Domain record(s) not found :: A domain record with hostname = data-frederickcountymd.opendata.arcgis.com does not exist :: 404"} |
| harford-county-dcat | unreachable | DCAT HTTP 404 {"error":"Domain record(s) not found :: A domain record with hostname = data-harfordcountymd.opendata.arcgis.com does not exist :: 404"} |
...
## Run 2026-07-24T09:21:28.865Z

- Sources re-probed: **18** · discovery targets walked: **44** · candidates evaluated: **197**
- Auto-wired: **none**
- Flagged new shapes (connector work needed — never guessed): **147**
- Dev-backed ZIPs snapshot: **1132** (Δ +0 vs last run)
...
| sandiego-county-arcgis | no-candidates | 61 services listed; none match the permit/land-use pattern |
| sanjose-ckan | flag | CKAN catalog with 7 permit-pattern dataset(s): Active Building Permits; Expired Building Permits; Last 30 days Planning Permits; Last 30 days building permits; Residential Parking Permit (RPP) Zones |
| santaclara-county-socrata → County of Santa Clara Permitted Body Art Facilities and Permitted Body Art Practitioners (mqx2-w62f) | flag | updated 2026-07-24; columns: facility_name, permit_type, site_address, city, zip, permitexpdate, facility_id, geo_address… |
| santaclara-county-socrata → County of Santa Clara Active Body Art Facilities and Permitted Body Art Practitioners (jwgu-xsep) | still-stale | rowsUpdatedAt = 2018-11-27 (> 400d old) |
| sunnyvale-arcgis-hub | unreachable | DCAT HTTP 0 UND_ERR_CONNECT_TIMEOUT |
| oakland-socrata → Residential Parking Permit Zones (su5x-2u99) | still-stale | rowsUpdatedAt = 2019-09-03 (> 400d old) |
| alameda-county-socrata | still-dead | catalog HTTP 404 <!DOCTYPE html>
...
| contracosta-county-arcgis → _Authoritative/Zoning/PLA_DCD_Zoning | flag | layer "PLA_DCD_Zoning" is esriGeometryPolygon |
| contracosta-county-arcgis → _Authoritative/Zoning/PLA_DCD_Zoning | flag | layer "PLA_DCD_Zoning" is esriGeometryPolygon |
| sonoma-county-socrata → Sonoma County Planning Permits (m689-iiuu) | flag | updated 2026-07-23; columns: file, status, application_type, started, address, description, parcel, sub_type… |
| sonoma-county-socrata → Sonoma County Rebuilding Permits (652y-5ihx) | flag | updated 2026-07-20; columns: record_id, date_opened, record_type, permit_status, category, permit_description, units, buildings, total_square_feet, situs_address, area_id, supervisors_district, event_title, first_inspection_date, parcel_number… |
| sonoma-county-socrata → Sonoma County Construction Permits (88ms-k5e7) | flag | updated 2026-07-23; columns: file_number, status, application_type, started, issued, address, description, assessors_parcel_number, totfee, value… |
| ventura-county-arcgis → DataDownloads/LandUse/Area plans | flag | layer "Area plans" is esriGeometryPolygon |
| ventura-county-arcgis → DataDownloads/LandUse/General Plan | flag | layer "General Plan" is esriGeometryPolygon |
| ventura-county-arcgis → DataDownloads/LandUse/Zone Designation | flag | layer "Zone Designation" is esriGeometryPolygon |
| ventura-county-arcgis → DataDownloads/LandUse/Area plans | flag | layer "Area plans" is esriGeometryPolygon |
...
| maricopa-county-arcgis → GIO/PermitHistory/Permit (Line) | flag | layer "Permit (Line)" is esriGeometryPolyline |
| maricopa-county-arcgis → GIO/PermitHistory/Permit (Polygon) | flag | layer "Permit (Polygon)" is esriGeometryPolygon |
| maricopa-county-arcgis → GIO/PermitHistory/Permit History (Point) | flag | fresh (newest 2026-07-23) but no lexicon status column among: OBJECTID, ModuleName, CaseID, CaseNumber, CaseType, WorkClass, ApplicationDate, ProjectID, ProjectName, GISHistoryQueueID, SpatialType, SpatialID |
| maricopa-county-arcgis → GIO/PermitHistory/Permit History (Line) | flag | layer "Permit History (Line)" is esriGeometryPolyline |
| maricopa-county-arcgis → GIO/PermitHistory/Permit History (Polygon) | flag | layer "Permit History (Polygon)" is esriGeometryPolygon |
| maricopa-county-arcgis → GIO/PermitHistory/Permit (Point) | flag | fresh (newest 2026-01-23) but no lexicon status column among: OBJECTID, Name, Description, CreatedDate, SHAPE |
| maricopa-county-arcgis → GIO/PermitHistory/Permit (Line) | flag | layer "Permit (Line)" is esriGeometryPolyline |
| maricopa-county-arcgis → GIO/PermitHistory/Permit (Polygon) | flag | layer "Permit (Polygon)" is esriGeometryPolygon |
| maricopa-county-arcgis → GIO/PermitHistory/Permit History (Point) | flag | fresh (newest 2026-07-23) but no lexicon status column among: OBJECTID, ModuleName, CaseID, CaseNumber, CaseType, WorkClass, ApplicationDate, ProjectID, ProjectName, GISHistoryQueueID, SpatialType, SpatialID, SHAPE |
| tucson-dcat → Zoning - Tucson - Open Data | flag | layer "ZONE_COT" is esriGeometryPolygon |
| tucson-dcat → Redevelopment Plans - Open Data | flag | layer "ZZ_PLAN_REDEV" is esriGeometryPolygon |
| tucson-dcat → Original City Zoning - Open Data | flag | layer "ZONE_OCZ" is esriGeometryPolygon |
| tucson-dcat → Subdivisions - Open Data | flag | layer "SUBDIV" is esriGeometryPolygon |
...
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http |
| montgomery-county-socrata → Mechanical Permits (ih88-a6aa) | flag | updated 2026-07-24; columns: permitno, status, stno, pre_direction, stname, suffix, postdir, city, state, zip, worktype, usecode, addeddate, issueddate, finaleddate… |
| montgomery-county-socrata → Electrical Building Permits (qxie-8qnp) | flag | updated 2026-07-24; columns: permitno, status, stno, predir, stname, suffix, postdir, city, state, zip, worktype, usecode, addeddate, issueddate, finaleddate… |
| montgomery-county-socrata → DPS - Antenna/Wireless Permits (djk9-h36c) | flag | updated 2026-07-23; columns: permit_number, permit_status, added_date, issue_date, final_date, tfcg_number, attachment_type, ozah, street_number, pre_direction, street_name, street_suffix, post_direction, city, state… |
| montgomery-county-socrata → Fence Permits (9quz-avmj) | flag | updated 2026-07-24; columns: application_type, permit_number, work_type, user_code, added_date, issue_date, final_date, expired_date, status, building_area, description_of_work, street_number, pre_direction, street_name, street_suffix… |
| montgomery-county-socrata → Sign Permits (piic-h4rw) | flag | updated 2026-07-22; columns: application_type, permit_no, work_type, use_code, added_date, issued_date, final_date, expired_date, status, building_area, description, st_no, pre_dir, st_name, suffix… |
| howard-county-socrata → Office of Consumer Protection Permits And Licenses (9rfk-bak7) | still-stale | rowsUpdatedAt = 2024-12-03 (> 400d old) |
| annearundel-arcgis → Hosted/2040_Land_Use_Changes/LU2040 Consistency Changes | flag | layer "LU2040 Consistency Changes" is esriGeometryPolygon |
| annearundel-arcgis → Hosted/2040_Land_Use_Changes/LU2040 Consistency Changes Dissolved | flag | layer "LU2040 Consistency Changes Dissolved" is esriGeometryPolygon |
...
| annearundel-arcgis → Hosted/Development_Policy_Areas/Development Policy Areas | flag | layer "Development Policy Areas" is esriGeometryPolygon |
| annearundel-arcgis → Hosted/GDP_Land_Use_Plan2040_May_2023/GDP_LandUse_Plan_2040_Update2023_04252023 | flag | layer "GDP_LandUse_Plan_2040_Update2023_04252023" is esriGeometryPolygon |
| baltimore-county-dcat → Plumbing Permits | flag | fresh (newest 2026-07-22) |
| baltimore-county-dcat → Gas Permits | flag | fresh (newest 2026-07-22) |
| baltimore-county-dcat → Electrical Permits | flag | fresh (newest 2026-07-22) |
| baltimore-county-dcat → Use and Occupancy Permits | flag | fresh (newest 2026-07-23) but no lexicon status column among: OBJECTID, CASE_NUMBER, CA_TASK_ID, ADDRESSSTREETNUMBER, ADDRESSSTREETNAME, ADDRESSCITY, ADDRESSSTATE, ADDRESSZIP, PEOPLEROLEID, OWNERNAME, OWNERADDRESS1, OWNERADDRESS2, OWNERADDRESS3, OWNERCITY, OWNERSTATE |
| baltimore-county-dcat → Proposed Landuse | flag | layer "Proposed Land Use - Smart Code" is esriGeometryPolygon |
| baltimore-county-dcat → Landuse | flag | layer "Landuse" is esriGeometryPolygon |
| baltimore-county-dcat → Subdivisions | flag | layer "Subdivisions" is esriGeometryPolygon |
| baltimore-county-dcat → Regional Planning Districts | flag | layer "Regional Planning Districts" is esriGeometryPolygon |
...
## Run 2026-07-25T09:02:34.181Z

- Sources re-probed: **18** · discovery targets walked: **44** · candidates evaluated: **197**
- Auto-wired: **none**
- Flagged new shapes (connector work needed — never guessed): **147**
- Dev-backed ZIPs snapshot: **340** (Δ -792 vs last run)
...
| sandiego-county-arcgis | no-candidates | 61 services listed; none match the permit/land-use pattern |
| sanjose-ckan | flag | CKAN catalog with 7 permit-pattern dataset(s): Active Building Permits; Expired Building Permits; Last 30 days Planning Permits; Last 30 days building permits; Residential Parking Permit (RPP) Zones |
| santaclara-county-socrata → County of Santa Clara Permitted Body Art Facilities and Permitted Body Art Practitioners (mqx2-w62f) | flag | updated 2026-07-25; columns: facility_name, permit_type, site_address, city, zip, permitexpdate, facility_id, geo_address… |
| santaclara-county-socrata → County of Santa Clara Active Body Art Facilities and Permitted Body Art Practitioners (jwgu-xsep) | still-stale | rowsUpdatedAt = 2018-11-27 (> 400d old) |
| sunnyvale-arcgis-hub | unreachable | DCAT HTTP 0 UND_ERR_CONNECT_TIMEOUT |
| oakland-socrata → Residential Parking Permit Zones (su5x-2u99) | still-stale | rowsUpdatedAt = 2019-09-03 (> 400d old) |
| alameda-county-socrata | still-dead | catalog HTTP 404 <!DOCTYPE html>
...
| sonoma-county-socrata → Sonoma County Planning Permits (m689-iiuu) | flag | updated 2026-07-23; columns: file, status, application_type, started, address, description, parcel, sub_type… |
| sonoma-county-socrata → Sonoma County Rebuilding Permits (652y-5ihx) | flag | updated 2026-07-20; columns: record_id, date_opened, record_type, permit_status, category, permit_description, units, buildings, total_square_feet, situs_address, area_id, supervisors_district, event_title, first_inspection_date, parcel_number… |
| sonoma-county-socrata → Sonoma County Construction Permits (88ms-k5e7) | flag | updated 2026-07-24; columns: file_number, status, application_type, started, issued, address, description, assessors_parcel_number, totfee, value… |
| ventura-county-arcgis → DataDownloads/LandUse/Area plans | flag | layer "Area plans" is esriGeometryPolygon |
| ventura-county-arcgis → DataDownloads/LandUse/General Plan | flag | layer "General Plan" is esriGeometryPolygon |
| ventura-county-arcgis → DataDownloads/LandUse/Zone Designation | flag | layer "Zone Designation" is esriGeometryPolygon |
| ventura-county-arcgis → DataDownloads/LandUse/Area plans | flag | layer "Area plans" is esriGeometryPolygon |
...
| mesa-socrata → Turn Around Time - Permits (fhtq-vpmm) | flag | updated 2026-07-22; columns: record_id, customid, record_type, record_open_date, record_status, statusdate, task, istaskcompleted, assigneddate, taskstatus, duedate, actionbyuser, status_year, status_month, turnaroundtime… |
| mesa-socrata → Temporary Traffic Control (TTC) Permits (822f-avdk) | flag | updated 2026-07-23; columns: rownum, record_id, customid, company, company_name, businessname, address_line1, application_date, review_date, calendardays, days_in_review, plan_review_days, status_date, record_status, received_date… |
| mesa-socrata → Development Services - Permit Submittals and Resubmittals Logged In (kg7m-y6f3) | flag | updated 2026-07-24; columns: row_number, record_id, record_type, type_of_submittal, record_open_date, record_open_date_month, record_open_date_year, record_status, record_status_date, record_status_month, record_status_year, task, task_complete_flag, description, status… |
| mesa-socrata → Planning - Board of Adjustment (BOA) Memos completed (qmv6-zhfq) | flag | updated 2026-07-25; columns: rowid, record_id, record_type, submittal_date, submission_deadline_date, distributed_date, review_consolidation_date, formal_submittal_deadline_date, permit_description, record_open_date, record_status_date, record_status_month, record_status_year, record_status, task… |
| mesa-socrata → DSD - Planning & Zoning and Design Review Memos Completion (u5a9-tj5y) | flag | updated 2026-07-23; columns: rowid, record_id, record_type, permit_description, record_open_date, record_status_date, record_status, submission_deadline_date, distributed_date, formal_submittal_deadline_date, review_consolidation_date, task, task_status, record_status_month, record_status_year… |
| tempe-socrata | still-dead | catalog HTTP 404 <!DOCTYPE html>
<html lang="en">
<head>
...
| maricopa-county-arcgis → GIO/PermitHistory/Permit (Line) | flag | layer "Permit (Line)" is esriGeometryPolyline |
| maricopa-county-arcgis → GIO/PermitHistory/Permit (Polygon) | flag | layer "Permit (Polygon)" is esriGeometryPolygon |
| maricopa-county-arcgis → GIO/PermitHistory/Permit History (Point) | flag | fresh (newest 2026-07-24) but no lexicon status column among: OBJECTID, ModuleName, CaseID, CaseNumber, CaseType, WorkClass, ApplicationDate, ProjectID, ProjectName, GISHistoryQueueID, SpatialType, SpatialID |
| maricopa-county-arcgis → GIO/PermitHistory/Permit History (Line) | flag | layer "Permit History (Line)" is esriGeometryPolyline |
| maricopa-county-arcgis → GIO/PermitHistory/Permit History (Polygon) | flag | layer "Permit History (Polygon)" is esriGeometryPolygon |
| maricopa-county-arcgis → GIO/PermitHistory/Permit (Point) | flag | fresh (newest 2026-01-23) but no lexicon status column among: OBJECTID, Name, Description, CreatedDate, SHAPE |
| maricopa-county-arcgis → GIO/PermitHistory/Permit (Line) | flag | layer "Permit (Line)" is esriGeometryPolyline |
| maricopa-county-arcgis → GIO/PermitHistory/Permit (Polygon) | flag | layer "Permit (Polygon)" is esriGeometryPolygon |
| maricopa-county-arcgis → GIO/PermitHistory/Permit History (Point) | flag | fresh (newest 2026-07-24) but no lexicon status column among: OBJECTID, ModuleName, CaseID, CaseNumber, CaseType, WorkClass, ApplicationDate, ProjectID, ProjectName, GISHistoryQueueID, SpatialType, SpatialID, SHAPE |
| tucson-dcat → Zoning - Tucson - Open Data | flag | layer "ZONE_COT" is esriGeometryPolygon |
| tucson-dcat → Redevelopment Plans - Open Data | flag | layer "ZZ_PLAN_REDEV" is esriGeometryPolygon |
| tucson-dcat → Original City Zoning - Open Data | flag | layer "ZONE_OCZ" is esriGeometryPolygon |
| tucson-dcat → Subdivisions - Open Data | flag | layer "SUBDIV" is esriGeometryPolygon |
...
| montgomery-county-socrata → Mechanical Permits (ih88-a6aa) | flag | updated 2026-07-24; columns: permitno, status, stno, pre_direction, stname, suffix, postdir, city, state, zip, worktype, usecode, addeddate, issueddate, finaleddate… |
| montgomery-county-socrata → Electrical Building Permits (qxie-8qnp) | flag | updated 2026-07-24; columns: permitno, status, stno, predir, stname, suffix, postdir, city, state, zip, worktype, usecode, addeddate, issueddate, finaleddate… |
| montgomery-county-socrata → DPS - Antenna/Wireless Permits (djk9-h36c) | flag | updated 2026-07-25; columns: permit_number, permit_status, added_date, issue_date, final_date, tfcg_number, attachment_type, ozah, street_number, pre_direction, street_name, street_suffix, post_direction, city, state… |
| montgomery-county-socrata → Fence Permits (9quz-avmj) | flag | updated 2026-07-25; columns: application_type, permit_number, work_type, user_code, added_date, issue_date, final_date, expired_date, status, building_area, description_of_work, street_number, pre_direction, street_name, street_suffix… |
| montgomery-county-socrata → Sign Permits (piic-h4rw) | flag | updated 2026-07-22; columns: application_type, permit_no, work_type, use_code, added_date, issued_date, final_date, expired_date, status, building_area, description, st_no, pre_dir, st_name, suffix… |
| howard-county-socrata → Office of Consumer Protection Permits And Licenses (9rfk-bak7) | still-stale | rowsUpdatedAt = 2024-12-03 (> 400d old) |
| annearundel-arcgis → Hosted/2040_Land_Use_Changes/LU2040 Consistency Changes | flag | layer "LU2040 Consistency Changes" is esriGeometryPolygon |
| annearundel-arcgis → Hosted/2040_Land_Use_Changes/LU2040 Consistency Changes Dissolved | flag | layer "LU2040 Consistency Changes Dissolved" is esriGeometryPolygon |
...
| annearundel-arcgis → Hosted/Development_Policy_Areas/Development Policy Areas | flag | layer "Development Policy Areas" is esriGeometryPolygon |
| annearundel-arcgis → Hosted/GDP_Land_Use_Plan2040_May_2023/GDP_LandUse_Plan_2040_Update2023_04252023 | flag | layer "GDP_LandUse_Plan_2040_Update2023_04252023" is esriGeometryPolygon |
| baltimore-county-dcat → Plumbing Permits | flag | fresh (newest 2026-07-24) |
| baltimore-county-dcat → Gas Permits | flag | fresh (newest 2026-07-22) |
| baltimore-county-dcat → Electrical Permits | flag | fresh (newest 2026-07-23) |
| baltimore-county-dcat → Use and Occupancy Permits | flag | fresh (newest 2026-07-24) but no lexicon status column among: OBJECTID, CASE_NUMBER, CA_TASK_ID, ADDRESSSTREETNUMBER, ADDRESSSTREETNAME, ADDRESSCITY, ADDRESSSTATE, ADDRESSZIP, PEOPLEROLEID, OWNERNAME, OWNERADDRESS1, OWNERADDRESS2, OWNERADDRESS3, OWNERCITY, OWNERSTATE |
| baltimore-county-dcat → Proposed Landuse | flag | layer "Proposed Land Use - Smart Code" is esriGeometryPolygon |
| baltimore-county-dcat → Landuse | flag | layer "Landuse" is esriGeometryPolygon |
| baltimore-county-dcat → Subdivisions | flag | layer "Subdivisions" is esriGeometryPolygon |
| baltimore-county-dcat → Regional Planning Districts | flag | layer "Regional Planning Districts" is esriGeometryPolygon |
...
## Run 2026-07-26T09:12:16.869Z

- Sources re-probed: **18** · discovery targets walked: **44** · candidates evaluated: **196**
- Auto-wired: **none**
- Flagged new shapes (connector work needed — never guessed): **147**
- Dev-backed ZIPs snapshot: **335** (Δ -5 vs last run)
...
| sandiego-county-arcgis | no-candidates | 61 services listed; none match the permit/land-use pattern |
| sanjose-ckan | flag | CKAN catalog with 7 permit-pattern dataset(s): Active Building Permits; Expired Building Permits; Last 30 days Planning Permits; Last 30 days building permits; Residential Parking Permit (RPP) Zones |
| santaclara-county-socrata → County of Santa Clara Permitted Body Art Facilities and Permitted Body Art Practitioners (mqx2-w62f) | flag | updated 2026-07-26; columns: facility_name, permit_type, site_address, city, zip, permitexpdate, facility_id, geo_address… |
| santaclara-county-socrata → County of Santa Clara Active Body Art Facilities and Permitted Body Art Practitioners (jwgu-xsep) | still-stale | rowsUpdatedAt = 2018-11-27 (> 400d old) |
| sunnyvale-arcgis-hub | unreachable | DCAT HTTP 0 UND_ERR_CONNECT_TIMEOUT |
| oakland-socrata → Residential Parking Permit Zones (su5x-2u99) | still-stale | rowsUpdatedAt = 2019-09-03 (> 400d old) |
| alameda-county-socrata | still-dead | catalog HTTP 404 <!DOCTYPE html>
...
| sonoma-county-socrata → Sonoma County Planning Permits (m689-iiuu) | flag | updated 2026-07-23; columns: file, status, application_type, started, address, description, parcel, sub_type… |
| sonoma-county-socrata → Sonoma County Rebuilding Permits (652y-5ihx) | flag | updated 2026-07-20; columns: record_id, date_opened, record_type, permit_status, category, permit_description, units, buildings, total_square_feet, situs_address, area_id, supervisors_district, event_title, first_inspection_date, parcel_number… |
| sonoma-county-socrata → Sonoma County Construction Permits (88ms-k5e7) | flag | updated 2026-07-25; columns: file_number, status, application_type, started, issued, address, description, assessors_parcel_number, totfee, value… |
| ventura-county-arcgis → DataDownloads/LandUse/Area plans | flag | layer "Area plans" is esriGeometryPolygon |
| ventura-county-arcgis → DataDownloads/LandUse/General Plan | flag | layer "General Plan" is esriGeometryPolygon |
| ventura-county-arcgis → DataDownloads/LandUse/Zone Designation | flag | layer "Zone Designation" is esriGeometryPolygon |
| ventura-county-arcgis → DataDownloads/LandUse/Area plans | flag | layer "Area plans" is esriGeometryPolygon |
...
## Run 2026-07-27T10:42:22.890Z

- Sources re-probed: **18** · discovery targets walked: **44** · candidates evaluated: **196**
- Auto-wired: **none**
- Flagged new shapes (connector work needed — never guessed): **145**
- Dev-backed ZIPs snapshot: **335** (Δ +0 vs last run)
...
| denver-dcat → Public Works Development Services Projects | flag | fields: OBJECTID, PROJECT_ID, PROJECT_NAME, PROJECT_DESCR, DATE_ENTERED, FULL_ADDRESS, ADDRRESS_ID, GLOBALID… |
| denver-dcat → Street Occupancy Permits | flag | layer "DEV_STREETOCCUPANCYPPERMITS_L" is esriGeometryPolyline |
| denver-dcat → ODC DEV DEMOLITIONPERMIT P | flag | fresh (newest 2026-07-23) but no lexicon status column among: OBJECTID, DATE_ISSUED, PERMIT_NUM, ADDRESS, LOCATION, CLASS, UNITS, VALUATION, PERMIT_FEE, CONTRACTOR_NAME, FINAL_DATE, CANCEL, DATE_RECEIVED, BID_AUTHNAME, LOG_NUM |
| springs-gis-root → GeneralUse/EconomicDevelopment/Foreign Trade Zones | flag | layer "Foreign Trade Zones" is esriGeometryPolygon |
| springs-gis-root → GeneralUse/EconomicDevelopment/Urban Renewal Areas | flag | layer "Urban Renewal Areas" is esriGeometryPolygon |
| springs-gis-root → GeneralUse/EconomicDevelopment/Qualified Opportunity Zones | flag | layer "Qualified Opportunity Zones" is esriGeometryPolygon |
| springs-gis-root → GeneralUse/EconomicDevelopment/Commercial Aeronautical Zones | flag | layer "Commercial Aeronautical Zones" is esriGeometryPolygon |
...
| sandiego-county-arcgis | no-candidates | 61 services listed; none match the permit/land-use pattern |
| sanjose-ckan | flag | CKAN catalog with 7 permit-pattern dataset(s): Active Building Permits; Expired Building Permits; Last 30 days Planning Permits; Last 30 days building permits; Residential Parking Permit (RPP) Zones |
| santaclara-county-socrata → County of Santa Clara Permitted Body Art Facilities and Permitted Body Art Practitioners (mqx2-w62f) | flag | updated 2026-07-27; columns: facility_name, permit_type, site_address, city, zip, permitexpdate, facility_id, geo_address… |
| santaclara-county-socrata → County of Santa Clara Active Body Art Facilities and Permitted Body Art Practitioners (jwgu-xsep) | still-stale | rowsUpdatedAt = 2018-11-27 (> 400d old) |
| sunnyvale-arcgis-hub | unreachable | DCAT HTTP 0 UND_ERR_CONNECT_TIMEOUT |
| oakland-socrata → Residential Parking Permit Zones (su5x-2u99) | still-stale | rowsUpdatedAt = 2019-09-03 (> 400d old) |
| alameda-county-socrata | still-dead | catalog HTTP 404 <!DOCTYPE html>
...
| contracosta-county-arcgis → _Authoritative/Zoning/PLA_DCD_Zoning | flag | layer "PLA_DCD_Zoning" is esriGeometryPolygon |
| contracosta-county-arcgis → _Authoritative/Zoning/PLA_DCD_Zoning | flag | layer "PLA_DCD_Zoning" is esriGeometryPolygon |
| sonoma-county-socrata → Sonoma County Planning Permits (m689-iiuu) | flag | updated 2026-07-26; columns: file, status, application_type, started, address, description, parcel, sub_type… |
| sonoma-county-socrata → Sonoma County Rebuilding Permits (652y-5ihx) | flag | updated 2026-07-26; columns: record_id, date_opened, record_type, permit_status, category, permit_description, units, buildings, total_square_feet, situs_address, area_id, supervisors_district, event_title, first_inspection_date, parcel_number… |
| sonoma-county-socrata → Sonoma County Construction Permits (88ms-k5e7) | flag | updated 2026-07-26; columns: file_number, status, application_type, started, issued, address, description, assessors_parcel_number, totfee, value… |
| ventura-county-arcgis → DataDownloads/LandUse/Area plans | flag | layer "Area plans" is esriGeometryPolygon |
| ventura-county-arcgis → DataDownloads/LandUse/General Plan | flag | layer "General Plan" is esriGeometryPolygon |
| ventura-county-arcgis → DataDownloads/LandUse/Zone Designation | flag | layer "Zone Designation" is esriGeometryPolygon |
| ventura-county-arcgis → DataDownloads/LandUse/Area plans | flag | layer "Area plans" is esriGeometryPolygon |
...
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http |
| montgomery-county-socrata → Mechanical Permits (ih88-a6aa) | flag | updated 2026-07-27; columns: permitno, status, stno, pre_direction, stname, suffix, postdir, city, state, zip, worktype, usecode, addeddate, issueddate, finaleddate… |
| montgomery-county-socrata → Electrical Building Permits (qxie-8qnp) | flag | updated 2026-07-27; columns: permitno, status, stno, predir, stname, suffix, postdir, city, state, zip, worktype, usecode, addeddate, issueddate, finaleddate… |
| montgomery-county-socrata → DPS - Antenna/Wireless Permits (djk9-h36c) | flag | updated 2026-07-25; columns: permit_number, permit_status, added_date, issue_date, final_date, tfcg_number, attachment_type, ozah, street_number, pre_direction, street_name, street_suffix, post_direction, city, state… |
| montgomery-county-socrata → Fence Permits (9quz-avmj) | flag | updated 2026-07-25; columns: application_type, permit_number, work_type, user_code, added_date, issue_date, final_date, expired_date, status, building_area, description_of_work, street_number, pre_direction, street_name, street_suffix… |
| montgomery-county-socrata → Sign Permits (piic-h4rw) | flag | updated 2026-07-22; columns: application_type, permit_no, work_type, use_code, added_date, issued_date, final_date, expired_date, status, building_area, description, st_no, pre_dir, st_name, suffix… |
| howard-county-socrata → Office of Consumer Protection Permits And Licenses (9rfk-bak7) | still-stale | rowsUpdatedAt = 2024-12-03 (> 400d old) |
...
<li>RequestId:  |
| sandiego-county-arcgis | no-candidates | 61 services listed; none match the permit/land-use pattern |
| sanjose-ckan | flag | CKAN catalog with 7 permit-pattern dataset(s): Active Building Permits; Expired Building Permits; Last 30 days building permits; Last 30 days Planning Permits; Residential Parking Permit (RPP) Zones |
| santaclara-county-socrata → County of Santa Clara Permitted Body Art Facilities and Permitted Body Art Practitioners (mqx2-w62f) | flag | updated 2026-07-28; columns: facility_name, permit_type, site_address, city, zip, permitexpdate, facility_id, geo_address… |
| santaclara-county-socrata → County of Santa Clara Active Body Art Facilities and Permitted Body Art Practitioners (jwgu-xsep) | still-stale | rowsUpdatedAt = 2018-11-27 (> 400d old) |
| sunnyvale-arcgis-hub | unreachable | DCAT HTTP 0 UND_ERR_CONNECT_TIMEOUT |
| oakland-socrata → Residential Parking Permit Zones (su5x-2u99) | still-stale | rowsUpdatedAt = 2019-09-03 (> 400d old) |
| alameda-county-socrata | still-dead | catalog HTTP 404 <!DOCTYPE html>
...
| contracosta-county-arcgis → _Authoritative/Zoning/PLA_DCD_Zoning | flag | layer "PLA_DCD_Zoning" is esriGeometryPolygon |
| contracosta-county-arcgis → _Authoritative/Zoning/PLA_DCD_Zoning | flag | layer "PLA_DCD_Zoning" is esriGeometryPolygon |
| sonoma-county-socrata → Sonoma County Planning Permits (m689-iiuu) | flag | updated 2026-07-27; columns: file, status, application_type, started, address, description, parcel, sub_type… |
...
| sonoma-county-socrata → Sonoma County Construction Permits (88ms-k5e7) | flag | updated 2026-07-27; columns: file_number, status, application_type, started, issued, address, description, assessors_parcel_number, totfee, value… |
| ventura-county-arcgis → DataDownloads/LandUse/Area plans | flag | layer "Area plans" is esriGeometryPolygon |
| ventura-county-arcgis → DataDownloads/LandUse/General Plan | flag | layer "General Plan" is esriGeometryPolygon |
| ventura-county-arcgis → DataDownloads/LandUse/Zone Designation | flag | layer "Zone Designation" is esriGeometryPolygon |
| ventura-county-arcgis → DataDownloads/LandUse/Area plans | flag | layer "Area plans" is esriGeometryPolygon |
...
| maricopa-county-arcgis → GIO/PermitHistory/Permit (Line) | flag | layer "Permit (Line)" is esriGeometryPolyline |
| maricopa-county-arcgis → GIO/PermitHistory/Permit (Polygon) | flag | layer "Permit (Polygon)" is esriGeometryPolygon |
| maricopa-county-arcgis → GIO/PermitHistory/Permit History (Point) | flag | fresh (newest 2026-07-27) but no lexicon status column among: OBJECTID, ModuleName, CaseID, CaseNumber, CaseType, WorkClass, ApplicationDate, ProjectID, ProjectName, GISHistoryQueueID, SpatialType, SpatialID |
| maricopa-county-arcgis → GIO/PermitHistory/Permit History (Line) | flag | layer "Permit History (Line)" is esriGeometryPolyline |
| maricopa-county-arcgis → GIO/PermitHistory/Permit History (Polygon) | flag | layer "Permit History (Polygon)" is esriGeometryPolygon |
| maricopa-county-arcgis → GIO/PermitHistory/Permit (Point) | flag | fresh (newest 2026-01-23) but no lexicon status column among: OBJECTID, Name, Description, CreatedDate, SHAPE |
| maricopa-county-arcgis → GIO/PermitHistory/Permit (Line) | flag | layer "Permit (Line)" is esriGeometryPolyline |
| maricopa-county-arcgis → GIO/PermitHistory/Permit (Polygon) | flag | layer "Permit (Polygon)" is esriGeometryPolygon |
| maricopa-county-arcgis → GIO/PermitHistory/Permit History (Point) | flag | fresh (newest 2026-07-27) but no lexicon status column among: OBJECTID, ModuleName, CaseID, CaseNumber, CaseType, WorkClass, ApplicationDate, ProjectID, ProjectName, GISHistoryQueueID, SpatialType, SpatialID, SHAPE |
| tucson-dcat → Zoning - Tucson - Open Data | flag | layer "ZONE_COT" is esriGeometryPolygon |
| tucson-dcat → Redevelopment Plans - Open Data | flag | layer "ZZ_PLAN_REDEV" is esriGeometryPolygon |
| tucson-dcat → Original City Zoning - Open Data | flag | layer "ZONE_OCZ" is esriGeometryPolygon |
| tucson-dcat → Subdivisions - Open Data | flag | layer "SUBDIV" is esriGeometryPolygon |
...
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http |
| montgomery-county-socrata → Mechanical Permits (ih88-a6aa) | flag | updated 2026-07-28; columns: permitno, status, stno, pre_direction, stname, suffix, postdir, city, state, zip, worktype, usecode, addeddate, issueddate, finaleddate… |
| montgomery-county-socrata → Electrical Building Permits (qxie-8qnp) | flag | updated 2026-07-28; columns: permitno, status, stno, predir, stname, suffix, postdir, city, state, zip, worktype, usecode, addeddate, issueddate, finaleddate… |
| montgomery-county-socrata → DPS - Antenna/Wireless Permits (djk9-h36c) | flag | updated 2026-07-28; columns: permit_number, permit_status, added_date, issue_date, final_date, tfcg_number, attachment_type, ozah, street_number, pre_direction, street_name, street_suffix, post_direction, city, state… |
| montgomery-county-socrata → Fence Permits (9quz-avmj) | flag | updated 2026-07-28; columns: application_type, permit_number, work_type, user_code, added_date, issue_date, final_date, expired_date, status, building_area, description_of_work, street_number, pre_direction, street_name, street_suffix… |
| montgomery-county-socrata → Sign Permits (piic-h4rw) | flag | updated 2026-07-28; columns: application_type, permit_no, work_type, use_code, added_date, issued_date, final_date, expired_date, status, building_area, description, st_no, pre_dir, st_name, suffix… |
| howard-county-socrata → Office of Consumer Protection Permits And Licenses (9rfk-bak7) | still-stale | rowsUpdatedAt = 2024-12-03 (> 400d old) |
| annearundel-arcgis → Hosted/2040_Land_Use_Changes/LU2040 Consistency Changes | flag | layer "LU2040 Consistency Changes" is esriGeometryPolygon |
| annearundel-arcgis → Hosted/2040_Land_Use_Changes/LU2040 Consistency Changes Dissolved | flag | layer "LU2040 Consistency Changes Dissolved" is esriGeometryPolygon |
| annearundel-arcgis → Hosted/Development_Policy_Area_Overlays_PreliminaryDraft/Development_Policy_Area_Overlays_PreliminaryDraft | flag | layer "Development_Policy_Area_Overlays_PreliminaryDraft" is esriGeometryPolygon |
...
| annearundel-arcgis → Hosted/GDP_Land_Use_Plan2040_May_2023/GDP_LandUse_Plan_2040_Update2023_04252023 | flag | layer "GDP_LandUse_Plan_2040_Update2023_04252023" is esriGeometryPolygon |
| baltimore-county-dcat → Plumbing Permits | flag | fresh (newest 2026-07-24) |
| baltimore-county-dcat → Gas Permits | flag | fresh (newest 2026-07-27) |
| baltimore-county-dcat → Electrical Permits | flag | fresh (newest 2026-07-23) |
| baltimore-county-dcat → Use and Occupancy Permits | flag | fresh (newest 2026-07-27) but no lexicon status column among: OBJECTID, CASE_NUMBER, CA_TASK_ID, ADDRESSSTREETNUMBER, ADDRESSSTREETNAME, ADDRESSCITY, ADDRESSSTATE, ADDRESSZIP, PEOPLEROLEID, OWNERNAME, OWNERADDRESS1, OWNERADDRESS2, OWNERADDRESS3, OWNERCITY, OWNERSTATE |
| baltimore-county-dcat → Proposed Landuse | flag | layer "Proposed Land Use - Smart Code" is esriGeometryPolygon |
| baltimore-county-dcat → Landuse | flag | layer "Landuse" is esriGeometryPolygon |
| baltimore-county-dcat → Subdivisions | flag | layer "Subdivisions" is esriGeometryPolygon |
| baltimore-county-dcat → Regional Planning Districts | flag | layer "Regional Planning Districts" is esriGeometryPolygon |
...
| baltimore-city-dcat → Planning District | skipped | host baltegis.baltimorecity.gov not on the target allowlist |
| baltimore-city-dcat → Housing and Building Permits  2015 to 2018 | flag | fresh (newest 3201-12-22) but no lexicon status column among: OBJECTID_1, CaseNumber, Description, ExpirationDate, IssuedDate, Address, BLOCKLOT, ExistingUse, ProposedUse, csm_projname, prc_block_no, prc_lot, Neighborhood, Cost, Council_District |
| baltimore-city-dcat → Number of New Construction Permits per 1,000 Residential Properties | unreachable | HTTP 304 |
...
## Run 2026-07-29T09:36:54.946Z

- Sources re-probed: **18** · discovery targets walked: **44** · candidates evaluated: **195**
- Auto-wired: **none**
- Flagged new shapes (connector work needed — never guessed): **147**
- Dev-backed ZIPs snapshot: **341** (Δ +6 vs last run)
...
| sandiego-county-arcgis | no-candidates | 61 services listed; none match the permit/land-use pattern |
| sanjose-ckan | flag | CKAN catalog with 7 permit-pattern dataset(s): Active Building Permits; Expired Building Permits; Last 30 days Planning Permits; Last 30 days building permits; Residential Parking Permit (RPP) Zones |
| santaclara-county-socrata → County of Santa Clara Permitted Body Art Facilities and Permitted Body Art Practitioners (mqx2-w62f) | flag | updated 2026-07-29; columns: facility_name, permit_type, site_address, city, zip, permitexpdate, facility_id, geo_address… |
| santaclara-county-socrata → County of Santa Clara Active Body Art Facilities and Permitted Body Art Practitioners (jwgu-xsep) | still-stale | rowsUpdatedAt = 2018-11-27 (> 400d old) |
| sunnyvale-arcgis-hub | unreachable | DCAT HTTP 0 UND_ERR_CONNECT_TIMEOUT |
| oakland-socrata → Residential Parking Permit Zones (su5x-2u99) | still-stale | rowsUpdatedAt = 2019-09-03 (> 400d old) |
| alameda-county-socrata | still-dead | catalog HTTP 404 <!DOCTYPE html>
...
| contracosta-county-arcgis → _Authoritative/Zoning/PLA_DCD_Zoning | flag | layer "PLA_DCD_Zoning" is esriGeometryPolygon |
| contracosta-county-arcgis → _Authoritative/Zoning/PLA_DCD_Zoning | flag | layer "PLA_DCD_Zoning" is esriGeometryPolygon |
| sonoma-county-socrata → Sonoma County Planning Permits (m689-iiuu) | flag | updated 2026-07-28; columns: file, status, application_type, started, address, description, parcel, sub_type… |
| sonoma-county-socrata → Sonoma County Rebuilding Permits (652y-5ihx) | flag | updated 2026-07-27; columns: record_id, date_opened, record_type, permit_status, category, permit_description, units, buildings, total_square_feet, situs_address, area_id, supervisors_district, event_title, first_inspection_date, parcel_number… |
| sonoma-county-socrata → Sonoma County Construction Permits (88ms-k5e7) | flag | updated 2026-07-28; columns: file_number, status, application_type, started, issued, address, description, assessors_parcel_number, totfee, value… |
| ventura-county-arcgis → DataDownloads/LandUse/Area plans | flag | layer "Area plans" is esriGeometryPolygon |
| ventura-county-arcgis → DataDownloads/LandUse/General Plan | flag | layer "General Plan" is esriGeometryPolygon |
| ventura-county-arcgis → DataDownloads/LandUse/Zone Designation | flag | layer "Zone Designation" is esriGeometryPolygon |
| ventura-county-arcgis → DataDownloads/LandUse/Area plans | flag | layer "Area plans" is esriGeometryPolygon |
...
| mesa-socrata → Building Permits (RETIRED) (2gkz-7z4f) | flag | updated 2026-01-07; columns: rowid, permit_number, property_address, street_number, street_direction, street_name, street_type, unit_number, council_district, issued_date, issued_year, issued_month, finaled_date, finaled_year, finaled_month… |
| mesa-socrata → Turn Around Time - Permits (fhtq-vpmm) | flag | updated 2026-07-22; columns: record_id, customid, record_type, record_open_date, record_status, statusdate, task, istaskcompleted, assigneddate, taskstatus, duedate, actionbyuser, status_year, status_month, turnaroundtime… |
| mesa-socrata → Temporary Traffic Control (TTC) Permits (822f-avdk) | unreachable | views API HTTP 0 |
| mesa-socrata → Development Services - Permit Submittals and Resubmittals Logged In (kg7m-y6f3) | flag | updated 2026-07-28; columns: row_number, record_id, record_type, type_of_submittal, record_open_date, record_open_date_month, record_open_date_year, record_status, record_status_date, record_status_month, record_status_year, task, task_complete_flag, description, status… |
| mesa-socrata → Planning - Board of Adjustment (BOA) Memos completed (qmv6-zhfq) | flag | updated 2026-07-25; columns: rowid, record_id, record_type, submittal_date, submission_deadline_date, distributed_date, review_consolidation_date, formal_submittal_deadline_date, permit_description, record_open_date, record_status_date, record_status_month, record_status_year, record_status, task… |
| mesa-socrata → DSD - Planning & Zoning and Design Review Memos Completion (u5a9-tj5y) | flag | updated 2026-07-23; columns: rowid, record_id, record_type, permit_description, record_open_date, record_status_date, record_status, submission_deadline_date, distributed_date, formal_submittal_deadline_date, review_consolidation_date, task, task_status, record_status_month, record_status_year… |
| tempe-socrata | still-dead | catalog HTTP 404 <!DOCTYPE html>
<html lang="en">
...
| maricopa-county-arcgis → GIO/PermitHistory/Permit (Line) | flag | layer "Permit (Line)" is esriGeometryPolyline |
| maricopa-county-arcgis → GIO/PermitHistory/Permit (Polygon) | flag | layer "Permit (Polygon)" is esriGeometryPolygon |
| maricopa-county-arcgis → GIO/PermitHistory/Permit History (Point) | flag | fresh (newest 2026-07-28) but no lexicon status column among: OBJECTID, ModuleName, CaseID, CaseNumber, CaseType, WorkClass, ApplicationDate, ProjectID, ProjectName, GISHistoryQueueID, SpatialType, SpatialID |
| maricopa-county-arcgis → GIO/PermitHistory/Permit History (Line) | flag | layer "Permit History (Line)" is esriGeometryPolyline |
| maricopa-county-arcgis → GIO/PermitHistory/Permit History (Polygon) | flag | layer "Permit History (Polygon)" is esriGeometryPolygon |
| maricopa-county-arcgis → GIO/PermitHistory/Permit (Point) | flag | fresh (newest 2026-01-23) but no lexicon status column among: OBJECTID, Name, Description, CreatedDate, SHAPE |
| maricopa-county-arcgis → GIO/PermitHistory/Permit (Line) | flag | layer "Permit (Line)" is esriGeometryPolyline |
| maricopa-county-arcgis → GIO/PermitHistory/Permit (Polygon) | flag | layer "Permit (Polygon)" is esriGeometryPolygon |
| maricopa-county-arcgis → GIO/PermitHistory/Permit History (Point) | flag | fresh (newest 2026-07-28) but no lexicon status column among: OBJECTID, ModuleName, CaseID, CaseNumber, CaseType, WorkClass, ApplicationDate, ProjectID, ProjectName, GISHistoryQueueID, SpatialType, SpatialID, SHAPE |
| tucson-dcat → Zoning - Tucson - Open Data | flag | layer "ZONE_COT" is esriGeometryPolygon |
| tucson-dcat → Redevelopment Plans - Open Data | flag | layer "ZZ_PLAN_REDEV" is esriGeometryPolygon |
| tucson-dcat → Original City Zoning - Open Data | flag | layer "ZONE_OCZ" is esriGeometryPolygon |
| tucson-dcat → Subdivisions - Open Data | flag | layer "SUBDIV" is esriGeometryPolygon |
...
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http |
| montgomery-county-socrata → Mechanical Permits (ih88-a6aa) | flag | updated 2026-07-29; columns: permitno, status, stno, pre_direction, stname, suffix, postdir, city, state, zip, worktype, usecode, addeddate, issueddate, finaleddate… |
| montgomery-county-socrata → Electrical Building Permits (qxie-8qnp) | flag | updated 2026-07-29; columns: permitno, status, stno, predir, stname, suffix, postdir, city, state, zip, worktype, usecode, addeddate, issueddate, finaleddate… |
| montgomery-county-socrata → DPS - Antenna/Wireless Permits (djk9-h36c) | flag | updated 2026-07-28; columns: permit_number, permit_status, added_date, issue_date, final_date, tfcg_number, attachment_type, ozah, street_number, pre_direction, street_name, street_suffix, post_direction, city, state… |
| montgomery-county-socrata → Sign Permits (piic-h4rw) | flag | updated 2026-07-28; columns: application_type, permit_no, work_type, use_code, added_date, issued_date, final_date, expired_date, status, building_area, description, st_no, pre_dir, st_name, suffix… |
| montgomery-county-socrata → Fence Permits (9quz-avmj) | flag | updated 2026-07-29; columns: application_type, permit_number, work_type, user_code, added_date, issue_date, final_date, expired_date, status, building_area, description_of_work, street_number, pre_direction, street_name, street_suffix… |
| howard-county-socrata → Office of Consumer Protection Permits And Licenses (9rfk-bak7) | still-stale | rowsUpdatedAt = 2024-12-03 (> 400d old) |
| annearundel-arcgis → Hosted/2040_Land_Use_Changes/LU2040 Consistency Changes | flag | layer "LU2040 Consistency Changes" is esriGeometryPolygon |
| annearundel-arcgis → Hosted/2040_Land_Use_Changes/LU2040 Consistency Changes Dissolved | flag | layer "LU2040 Consistency Changes Dissolved" is esriGeometryPolygon |
| annearundel-arcgis → Hosted/Development_Policy_Area_Overlays_PreliminaryDraft/Development_Policy_Area_Overlays_PreliminaryDraft | flag | layer "Development_Policy_Area_Overlays_PreliminaryDraft" is esriGeometryPolygon |
...
| annearundel-arcgis → Hosted/GDP_Land_Use_Plan2040_May_2023/GDP_LandUse_Plan_2040_Update2023_04252023 | flag | layer "GDP_LandUse_Plan_2040_Update2023_04252023" is esriGeometryPolygon |
| baltimore-county-dcat → Plumbing Permits | flag | fresh (newest 2026-07-24) |
| baltimore-county-dcat → Gas Permits | flag | fresh (newest 2026-07-28) |
| baltimore-county-dcat → Electrical Permits | flag | fresh (newest 2026-07-27) |
| baltimore-county-dcat → Use and Occupancy Permits | flag | fresh (newest 2026-07-28) but no lexicon status column among: OBJECTID, CASE_NUMBER, CA_TASK_ID, ADDRESSSTREETNUMBER, ADDRESSSTREETNAME, ADDRESSCITY, ADDRESSSTATE, ADDRESSZIP, PEOPLEROLEID, OWNERNAME, OWNERADDRESS1, OWNERADDRESS2, OWNERADDRESS3, OWNERCITY, OWNERSTATE |
| baltimore-county-dcat → Proposed Landuse | flag | layer "Proposed Land Use - Smart Code" is esriGeometryPolygon |
| baltimore-county-dcat → Landuse | flag | layer "Landuse" is esriGeometryPolygon |
| baltimore-county-dcat → Subdivisions | flag | layer "Subdivisions" is esriGeometryPolygon |
| baltimore-county-dcat → Regional Planning Districts | flag | layer "Regional Planning Districts" is esriGeometryPolygon |
...
| baltimore-city-dcat → Number of New Construction Permits per 1,000 Residential Properties | flag | layer "Number of New Construction Permits per 1,000 Residential Properties - Community Statistical Area" is esriGeometryPolygon |
| baltimore-city-dcat → Number of New Construction Permits per 1,000 Residential Properties - City | flag | layer "Number of New Construction Permits per 1,000 Residential Properties - City" is esriGeometryPolygon |
| baltimore-city-dcat → Number of Demolition Permits per 1,000 Residential Properties | flag | layer "Number of Demolition Permits per 1,000 Residential Properties - Community Statistical Area" is esriGeometryPolygon |
| baltimore-city-dcat → Number of Demolition Permits per 1,000 Residential Properties - City | flag | layer "Number of Demolition Permits per 1,000 Residential Properties - City" is esriGeometryPolygon |
...
- **baltimore-city-dcat → Number of New Construction Permits per 1,000 Residential Properties** — esriGeometryPolygon geometry: point-derivation (centroid) support in sources/arcgis.ts, or reject: intersection-style locations carry no parcel point
- **baltimore-city-dcat → Number of New Construction Permits per 1,000 Residential Properties - City** — esriGeometryPolygon geometry: point-derivation (centroid) support in sources/arcgis.ts, or reject: intersection-style locations carry no parcel point
- **baltimore-city-dcat → Number of Demolition Permits per 1,000 Residential Properties** — esriGeometryPolygon geometry: point-derivation (centroid) support in sources/arcgis.ts, or reject: intersection-style locations carry no parcel point
- **baltimore-city-dcat → Number of Demolition Permits per 1,000 Residential Properties - City** — esriGeometryPolygon geometry: point-derivation (centroid) support in sources/arcgis.ts, or reject: intersection-style locations carry no parcel point

## Run 2026-07-30T09:29:19.220Z

- Sources re-probed: **18** · discovery targets walked: **44** · candidates evaluated: **192**
- Auto-wired: **none**
- Flagged new shapes (connector work needed — never guessed): **142**
- Dev-backed ZIPs snapshot: **351** (Δ +10 vs last run)
...
| denton-county-arcgis → ContourPermits_GC/2 Foot Contours - 2005 | flag | layer "2 Foot Contours - 2005" is esriGeometryPolyline |
| denton-county-arcgis → ContourPermits_GC/2 Foot Contours - LIDAR 2000 | flag | layer "2 Foot Contours - LIDAR 2000" is esriGeometryPolyline |
| jeffco-dcat | no-candidates | 15 datasets; none match the permit/land-use pattern |
| adams-co-dcat → Zoning | flag | layer "Zoning" is esriGeometryPolygon |
| adams-co-dcat → Subdivisions | flag | layer "Subdivisions" is esriGeometryPolygon |
| adams-co-dcat → Advancing Adams Future Land Use 2022 | flag | layer "Advancing_Adams_FLU" is esriGeometryPolygon |
| boulder-city-dcat → BVCP Future Land Use | flag | layer "Future Land Use" is esriGeometryPolygon |
...
| denver-dcat → Public Works Development Services Projects | flag | fields: OBJECTID, PROJECT_ID, PROJECT_NAME, PROJECT_DESCR, DATE_ENTERED, FULL_ADDRESS, ADDRRESS_ID, GLOBALID… |
| denver-dcat → Street Occupancy Permits | flag | layer "DEV_STREETOCCUPANCYPPERMITS_L" is esriGeometryPolyline |
| denver-dcat → ODC DEV DEMOLITIONPERMIT P | flag | fresh (newest 2026-07-28) but no lexicon status column among: OBJECTID, DATE_ISSUED, PERMIT_NUM, ADDRESS, LOCATION, CLASS, UNITS, VALUATION, PERMIT_FEE, CONTRACTOR_NAME, FINAL_DATE, CANCEL, DATE_RECEIVED, BID_AUTHNAME, LOG_NUM |
| denver-dcat → Sewer Use and Drainage Permit Reviewer Areas | flag | layer "ADMN_SUDPREVIEWAREAS_A" is esriGeometryPolygon |
| denver-dcat → Development Review Areas | flag | layer "ADMN_DEVREVIEW_A" is esriGeometryPolygon |
| springs-gis-root → GeneralUse/EconomicDevelopment/Foreign Trade Zones | flag | layer "Foreign Trade Zones" is esriGeometryPolygon |
| springs-gis-root → GeneralUse/EconomicDevelopment/Urban Renewal Areas | flag | layer "Urban Renewal Areas" is esriGeometryPolygon |
...
| sandiego-county-arcgis | no-candidates | 61 services listed; none match the permit/land-use pattern |
| sanjose-ckan | flag | CKAN catalog with 7 permit-pattern dataset(s): Active Building Permits; Expired Building Permits; Last 30 days Planning Permits; Last 30 days building permits; Residential Parking Permit (RPP) Zones |
| santaclara-county-socrata → County of Santa Clara Permitted Body Art Facilities and Permitted Body Art Practitioners (mqx2-w62f) | flag | updated 2026-07-30; columns: facility_name, permit_type, site_address, city, zip, permitexpdate, facility_id, geo_address… |
| santaclara-county-socrata → County of Santa Clara Active Body Art Facilities and Permitted Body Art Practitioners (jwgu-xsep) | still-stale | rowsUpdatedAt = 2018-11-27 (> 400d old) |
| sunnyvale-arcgis-hub | unreachable | DCAT HTTP 0 UND_ERR_CONNECT_TIMEOUT |
| oakland-socrata → Residential Parking Permit Zones (su5x-2u99) | still-stale | rowsUpdatedAt = 2019-09-03 (> 400d old) |
| alameda-county-socrata | still-dead | catalog HTTP 404 <!DOCTYPE html>
...
| contracosta-county-arcgis → _Authoritative/Zoning/PLA_DCD_Zoning | flag | layer "PLA_DCD_Zoning" is esriGeometryPolygon |
| contracosta-county-arcgis → _Authoritative/Zoning/PLA_DCD_Zoning | flag | layer "PLA_DCD_Zoning" is esriGeometryPolygon |
| sonoma-county-socrata → Sonoma County Planning Permits (m689-iiuu) | flag | updated 2026-07-29; columns: file, status, application_type, started, address, description, parcel, sub_type… |
| sonoma-county-socrata → Sonoma County Rebuilding Permits (652y-5ihx) | flag | updated 2026-07-27; columns: record_id, date_opened, record_type, permit_status, category, permit_description, units, buildings, total_square_feet, situs_address, area_id, supervisors_district, event_title, first_inspection_date, parcel_number… |
| sonoma-county-socrata → Sonoma County Construction Permits (88ms-k5e7) | flag | updated 2026-07-29; columns: file_number, status, application_type, started, issued, address, description, assessors_parcel_number, totfee, value… |
| ventura-county-arcgis → DataDownloads/LandUse/Area plans | flag | layer "Area plans" is esriGeometryPolygon |
| ventura-county-arcgis → DataDownloads/LandUse/General Plan | flag | layer "General Plan" is esriGeometryPolygon |
| ventura-county-arcgis → DataDownloads/LandUse/Zone Designation | flag | layer "Zone Designation" is esriGeometryPolygon |
| ventura-county-arcgis → DataDownloads/LandUse/Area plans | flag | layer "Area plans" is esriGeometryPolygon |
...
| phoenix-ckan | flag | CKAN catalog with 2 permit-pattern dataset(s): Phoenix, AZ Building Permit Data; Proposed Zoning |
| mesa-socrata → Building Permits (RETIRED) (2gkz-7z4f) | flag | updated 2026-01-07; columns: rowid, permit_number, property_address, street_number, street_direction, street_name, street_type, unit_number, council_district, issued_date, issued_year, issued_month, finaled_date, finaled_year, finaled_month… |
| mesa-socrata → Turn Around Time - Permits (fhtq-vpmm) | flag | updated 2026-07-29; columns: record_id, customid, record_type, record_open_date, record_status, statusdate, task, istaskcompleted, assigneddate, taskstatus, duedate, actionbyuser, status_year, status_month, turnaroundtime… |
| mesa-socrata → Temporary Traffic Control (TTC) Permits (822f-avdk) | flag | updated 2026-07-30; columns: rownum, record_id, customid, company, company_name, businessname, address_line1, application_date, review_date, calendardays, days_in_review, plan_review_days, status_date, record_status, received_date… |
| mesa-socrata → Development Services - Permit Submittals and Resubmittals Logged In (kg7m-y6f3) | flag | updated 2026-07-29; columns: row_number, record_id, record_type, type_of_submittal, record_open_date, record_open_date_month, record_open_date_year, record_status, record_status_date, record_status_month, record_status_year, task, task_complete_flag, description, status… |
| mesa-socrata → Planning - Board of Adjustment (BOA) Memos completed (qmv6-zhfq) | flag | updated 2026-07-25; columns: rowid, record_id, record_type, submittal_date, submission_deadline_date, distributed_date, review_consolidation_date, formal_submittal_deadline_date, permit_description, record_open_date, record_status_date, record_status_month, record_status_year, record_status, task… |
| tempe-socrata | still-dead | catalog HTTP 404 <!DOCTYPE html>
<html lang="en">
<head>
...
| maricopa-county-arcgis → GIO/PermitHistory/Permit (Line) | flag | layer "Permit (Line)" is esriGeometryPolyline |
| maricopa-county-arcgis → GIO/PermitHistory/Permit (Polygon) | flag | layer "Permit (Polygon)" is esriGeometryPolygon |
| maricopa-county-arcgis → GIO/PermitHistory/Permit History (Point) | flag | fresh (newest 2026-07-29) but no lexicon status column among: OBJECTID, ModuleName, CaseID, CaseNumber, CaseType, WorkClass, ApplicationDate, ProjectID, ProjectName, GISHistoryQueueID, SpatialType, SpatialID |
| maricopa-county-arcgis → GIO/PermitHistory/Permit History (Line) | flag | layer "Permit History (Line)" is esriGeometryPolyline |
| maricopa-county-arcgis → GIO/PermitHistory/Permit History (Polygon) | flag | layer "Permit History (Polygon)" is esriGeometryPolygon |
| maricopa-county-arcgis → GIO/PermitHistory/Permit (Point) | flag | fresh (newest 2026-01-23) but no lexicon status column among: OBJECTID, Name, Description, CreatedDate, SHAPE |
| maricopa-county-arcgis → GIO/PermitHistory/Permit (Line) | flag | layer "Permit (Line)" is esriGeometryPolyline |
| maricopa-county-arcgis → GIO/PermitHistory/Permit (Polygon) | flag | layer "Permit (Polygon)" is esriGeometryPolygon |
| maricopa-county-arcgis → GIO/PermitHistory/Permit History (Point) | flag | fresh (newest 2026-07-29) but no lexicon status column among: OBJECTID, ModuleName, CaseID, CaseNumber, CaseType, WorkClass, ApplicationDate, ProjectID, ProjectName, GISHistoryQueueID, SpatialType, SpatialID, SHAPE |
| tucson-dcat → Zoning - Tucson - Open Data | flag | layer "ZONE_COT" is esriGeometryPolygon |
| tucson-dcat → Redevelopment Plans - Open Data | flag | layer "ZZ_PLAN_REDEV" is esriGeometryPolygon |
| tucson-dcat → Original City Zoning - Open Data | flag | layer "ZONE_OCZ" is esriGeometryPolygon |
| tucson-dcat → Subdivisions - Open Data | flag | layer "SUBDIV" is esriGeometryPolygon |
...
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http |
| montgomery-county-socrata → Mechanical Permits (ih88-a6aa) | flag | updated 2026-07-30; columns: permitno, status, stno, pre_direction, stname, suffix, postdir, city, state, zip, worktype, usecode, addeddate, issueddate, finaleddate… |
| montgomery-county-socrata → Electrical Building Permits (qxie-8qnp) | flag | updated 2026-07-30; columns: permitno, status, stno, predir, stname, suffix, postdir, city, state, zip, worktype, usecode, addeddate, issueddate, finaleddate… |
| montgomery-county-socrata → DPS - Antenna/Wireless Permits (djk9-h36c) | flag | updated 2026-07-28; columns: permit_number, permit_status, added_date, issue_date, final_date, tfcg_number, attachment_type, ozah, street_number, pre_direction, street_name, street_suffix, post_direction, city, state… |
| montgomery-county-socrata → Fence Permits (9quz-avmj) | flag | updated 2026-07-29; columns: application_type, permit_number, work_type, user_code, added_date, issue_date, final_date, expired_date, status, building_area, description_of_work, street_number, pre_direction, street_name, street_suffix… |
| montgomery-county-socrata → Sign Permits (piic-h4rw) | flag | updated 2026-07-28; columns: application_type, permit_no, work_type, use_code, added_date, issued_date, final_date, expired_date, status, building_area, description, st_no, pre_dir, st_name, suffix… |
| howard-county-socrata → Office of Consumer Protection Permits And Licenses (9rfk-bak7) | still-stale | rowsUpdatedAt = 2024-12-03 (> 400d old) |
...
| annearundel-arcgis → Hosted/GDP_Land_Use_Plan2040_May_2023/GDP_LandUse_Plan_2040_Update2023_04252023 | flag | layer "GDP_LandUse_Plan_2040_Update2023_04252023" is esriGeometryPolygon |
| baltimore-county-dcat → Plumbing Permits | flag | fresh (newest 2026-07-24) |
| baltimore-county-dcat → Gas Permits | flag | fresh (newest 2026-07-29) |
| baltimore-county-dcat → Electrical Permits | flag | fresh (newest 2026-07-27) |
| baltimore-county-dcat → Use and Occupancy Permits | flag | fresh (newest 2026-07-29) but no lexicon status column among: OBJECTID, CASE_NUMBER, CA_TASK_ID, ADDRESSSTREETNUMBER, ADDRESSSTREETNAME, ADDRESSCITY, ADDRESSSTATE, ADDRESSZIP, PEOPLEROLEID, OWNERNAME, OWNERADDRESS1, OWNERADDRESS2, OWNERADDRESS3, OWNERCITY, OWNERSTATE |
| baltimore-county-dcat → Proposed Landuse | flag | layer "Proposed Land Use - Smart Code" is esriGeometryPolygon |
| baltimore-county-dcat → Landuse | flag | layer "Landuse" is esriGeometryPolygon |
| baltimore-county-dcat → Subdivisions | flag | layer "Subdivisions" is esriGeometryPolygon |
| baltimore-county-dcat → Regional Planning Districts | flag | layer "Regional Planning Districts" is esriGeometryPolygon |
