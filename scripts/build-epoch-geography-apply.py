...
overwritten). Run: python3 scripts/build-epoch-geography-apply.py [--check]
"""
...
def build():
    ...
    guard = ["do $guard$",
             ...
             "  end if;",
             "end $guard$;"]
    parts = ['-- GENERATED by scripts/build-epoch-geography-apply.py from the DDL of record. Do not edit.',
