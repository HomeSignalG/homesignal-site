...
HS.onReady(async function () {
  ...
  page.innerHTML =
    ...
    + '<button type="button" class="lenscard" style="opacity:.55;cursor:pointer" onclick="HS.openModal(\'premiumModal\')"><span class="q">Demographics</span><span class="d">Premium · Coming soon</span></button>'
    + '<button type="button" class="lenscard" style="opacity:.55;cursor:pointer" onclick="HS.openModal(\'premiumModal\')"><span class="q">Economy &amp; Market</span><span class="d">Premium · Coming soon</span></button>'
    + '</div>'
    + '<div class="cols"><div>'
    ...
    + '<button type="button" class="inlinebtn" style="margin-top:12px" onclick="HS.openModal(\'premiumModal\')">Get Premium access →</button></div>'
    + '</div></div>';
