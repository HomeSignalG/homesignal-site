...
HS.onReady(async function () {
  ...
  // It is an AREA label (not `precise`), so on a resident's own home ZIP the control still
  // reads "Your home · <street>" — the affordance they rely on (see shell.js::paintTopbar).
