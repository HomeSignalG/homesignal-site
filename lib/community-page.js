...
HS.onReady(async function () {
  ...
  //
  // PARENT CTA STAYS. "View Development Map →" already sits in the header above. Map Full
  // View lives inside Map 1's embed (target=_top so it does not navigate the frame), not in
  // this host's iframe markup.
