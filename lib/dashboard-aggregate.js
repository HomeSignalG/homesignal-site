...
(function () {
  ...
  // Resident-facing labels. The internal kind keys (`address`/`zip`) and the route values
  ...
  var RAIL_PLACE_GROUPS = [
    { kind: 'address', label: 'Property Addresses', view: 'addresses' },
    { kind: 'zip', label: 'ZIP Codes', view: 'zips' }
  ];
