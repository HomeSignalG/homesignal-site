...
(function () {
  ...
  // end. When it is false the label drops the numeral entirely rather than qualifying it:
  // "View more changes" promises only what it delivers.
  var PREVIEW_LIMIT = 8;
  var EXPAND_UNKNOWN_LABEL = 'View more changes \u2192';
  ...
  var api = {
    ...
    DEV_QUERY_LIMIT: 8,
    EXPAND_UNKNOWN_LABEL: EXPAND_UNKNOWN_LABEL,
