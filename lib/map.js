...
(function () {
  ...
  // exposes the constructor but refuses the context returns false here, which is the whole
  // point: presence of the API is not capability.
  ...
  // Secondary line — factual, vendor-neutral, and OPTIONAL. It states a requirement; it does
  // not instruct anyone to change anything. Rendered only where there is room for it.
  HS.MAP3D_FALLBACK_DETAIL = '3D views require WebGL and hardware-accelerated graphics.';
