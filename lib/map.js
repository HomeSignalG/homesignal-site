...
(function () {
  ...
  const MapProvider = {
    ...
    render(el, opts) {
      ...
      const homeMark = showHome ? `
        ...
        <text x="${cx}" y="${cy+34}" font-size="11.5" fill="#16211c" stroke="#fff" stroke-width="4" paint-order="stroke" text-anchor="middle" font-weight="700" font-family="sans-serif">${HS.esc(homeTitle || 'Your home')}</text>${homeAddr}</g>` : '';
  ...
  HS.buildLive = function (el, o) {
    ...
    function schematic() {
      try {
        const homeTitle = o.homeTitle || 'Your home';
        MapProvider.render(el, { home: center, items: items, radiusMi: o.radiusMi || 1.5,
          showRadius: o.radiusMi != null, showHome: !!o.home,
          homeTitle: homeTitle,
          homeLabel: o.home ? (homeTitle === 'Your home' ? (o.home.address || '') : '') : '',
      ...
      HS.loadLeaflet(function (ok) {
        ...
        try {
          ...
          if (o.home) L.marker([o.home.lat, o.home.lng], { zIndexOffset: 1000, icon: div(HS.homeMarkerHTML(22), 22),
            title: (o.homeTitle || 'Your home') + ' · ' + (HS.homeAddressLine ? HS.homeAddressLine(o.home) : o.home.address || '') }).addTo(m);
    ...
    map.on('load', function () {
      ...
      try {
        ...
        if (o.home) {   // ONLY a real resident home — never a centroid stand-in; on top of items
          ...
          h.title = (o.homeTitle || 'Your home') + ' · ' + (HS.homeAddressLine ? HS.homeAddressLine(o.home) : o.home.address || '');
