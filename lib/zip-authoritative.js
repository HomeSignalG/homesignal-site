...
(function () {
  ...
  //   3. ⛔ KNOWN OPEN — THE FACILITY PLANE (EPA FRS points in development_reports.sites) IS STILL
  //      RADIUS-DERIVED AND IS NOT MEMBERSHIP-GATED HERE. Measured 2026-09-22: 103,724 of
  //      216,221 sit outside their ZIP and every one draws a Type pin. The row-level fix (a
  //      plane-wide trigger stamping every facility) was applied and REVERTED the same day:
  //      its bulk backfill coincided with three production Postgres restarts. It is kept here,
  //      unchanged and pinned by test, until a memory-safe design is measured — see CLAUDE.md
  //      §7.08. Do NOT "fix" it by filtering on coordinates in this module.
  ...
  // are REPLACED by authoritative whole-ZIP development. Everything else the cached report
  // carries is preserved untouched:
  //   * facilities (scope point, not relevance development) - the EPA national floor, still
  //     radius-derived and therefore NOT a whole-ZIP claim (the KNOWN OPEN plane above);
